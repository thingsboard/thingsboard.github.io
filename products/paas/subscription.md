...
See feature [documentation](/docs/user-guide/white-labeling/) for more details. ThingsBoard Cloud extends white-labeling feature (except own SMTP server) with ability to configure own domain name easily. 
