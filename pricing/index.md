    ...
    <div id="thingsboard-pe-options" class="select-product-content justify-content-center align-items-center" style="display: none;">
        <div class="product-selector product-selector-outlined">
            <div id="Pricing_CE"
                ...
                <h3 id="Pricing_CE" class="gtm_button" data-faq-id="what-is-tb-ce" data-tooltip="<p>Community Edition is the free, open-source starting point—perfect for fast pilots and proof-of-value. Start small, validate quickly, and scale up when you’re ready.</p>"
            ...
            <div id="Pricing_PE_Cloud"
                ...
                <h3 id="Pricing_PE_Cloud" class="gtm_button" data-faq-id="tb-cloud-definition" data-tooltip="<p>Public Cloud is fully managed ThingsBoard—built for speed. We handle infrastructure, upgrades, and reliability so your team can focus on shipping IoT solutions faster.</p>"
            ...
            <div id="Pricing_PE_PrivateCloud"
                ...
                <h3 id="Pricing_PE_PrivateCloud" class="gtm_button" data-faq-id="tb-private-cloud-what-does-thingsboard-private-cloud-stand-for" data-tooltip="<p>Private Cloud is a dedicated, isolated ThingsBoard Professional Edition cluster run by us for you. You get enterprise-grade control and security—without the ops overhead.</p>"
            ...
            <div id="Pricing_PE_SM" class="solution thingsboard-pe gtm_button" data-product-id="thingsboard-pe" onClick="activateProductSection('thingsboard-pe')">
                <h3 id="Pricing_PE_SM" class="gtm_button" data-faq-id="pe-pay-as-you-go-self-managed-definition" data-faq-link-size="70%" data-tooltip="<p>Self-managed lets you run ThingsBoard on your own infrastructure (on-prem or cloud). Ideal when you need full environment control and prefer to manage operations in-house.</p>">Self-managed</h3>
            </div>
        </div>
    </div>
            ...
            <div class="pricing-section pricing-cloud active" id="northAmerica">
                <div class="cards-row">
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item" data-faq-id="tb-cloud-device-msg-data-storage-limits-for-plans" data-tooltip="<p>Data points/month is your monthly telemetry allowance. One data point = one measurement (one key/value). You can buy extra Traffic pack anytime to scale up. For full definitions, see the Plans definition <a target='_blank' href='/docs/paas/subscriptions/'>page</a>.</p>">10M data points/month</div>
                        <div class="pricing-square-item" data-faq-id="tb-cloud-support-included" data-tooltip="<p>Get help through our community channel <a href='https://github.com/thingsboard/thingsboard/issues' target='_blank'>on GitHub</a></p>">
                            Community support
                        </div>
                    ...
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item" data-faq-id="tb-cloud-device-msg-data-storage-limits-for-plans" data-tooltip="<p>Data points/month is your monthly telemetry allowance. One data point = one measurement (one key/value). You can buy extra Traffic pack anytime to scale up. For full definitions, see the Plans definition <a target='_blank' href='/docs/paas/subscriptions/'>page</a>.</p>">50M data points/month</div>
                        <div class="pricing-square-item" data-faq-id="tb-cloud-support-included" data-tooltip="<p>Get help through our community channel <a href='https://github.com/thingsboard/thingsboard/issues' target='_blank'>on GitHub</a></p>">
                            Community support
                        </div>
                        <div class="pricing-square-item no-icon">&nbsp;</div>
                    ...
                    <div class="pricing-square popular">
                        ...
                        <div class="pricing-square-item" data-faq-id="tb-cloud-device-msg-data-storage-limits-for-plans" data-tooltip="<p>Data points/month is your monthly telemetry allowance. One data point = one measurement (one key/value). You can buy extra Traffic pack anytime to scale up. For full definitions, see the Plans definition <a target='_blank' href='/docs/paas/subscriptions/'>page</a>.</p>">100M data points/month</div>
                        <div class="pricing-square-item" data-faq-id="tb-cloud-support-included" data-tooltip="<p>Get access to our official support desk for product questions and troubleshooting—so you can resolve issues faster and keep your rollout on track.</p>">
                            Help desk
                        </div>
                    ...
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item" data-faq-id="tb-cloud-device-msg-data-storage-limits-for-plans" data-tooltip="<p>Data points/month is your monthly telemetry allowance. One data point = one measurement (one key/value). You can buy extra Traffic pack anytime to scale up. For full definitions, see the Plans definition <a target='_blank' href='/docs/paas/subscriptions/'>page</a>.</p>">500M data points/month</div>
                        <div class="pricing-square-item" data-faq-id="tb-cloud-support-included" data-tooltip="<p>Get priority handling in the support desk—faster response, faster resolution, and fewer blockers as you scale and run production workloads</p>">
                            Priority help desk
                        </div>
                        <div class="pricing-square-item highlight" data-faq-id="tb-cloud-white-labeling" data-tooltip="<p>White labeling lets you brand the platform as your own—use your logo, colors, and custom domain for a polished, client-ready experience that strengthens trust and keeps your brand front and center.\n You can add more devices anytime. After the 1,000 included devices, each additional device is $0.30 per month—so you can scale anytime.</p>">White labeling</div>
                        <div class="pricing-square-item no-icon">&nbsp;</div>
                    </div>
                    <div class="pricing-square">
                        <h2>Business</h2>
                        ...
                        <div class="pricing-square-item" data-faq-id="tb-cloud-device-msg-data-storage-limits-for-plans" data-tooltip="<p>Data points/month is your monthly telemetry allowance. One data point = one measurement (one key/value). You can buy extra Traffic pack anytime to scale up. For full definitions, see the Plans definition <a target='_blank' href='/docs/paas/subscriptions/'>page</a>.</p>">1B data points/month</div>
                        <div class="pricing-square-item" data-faq-id="tb-cloud-support-included" data-tooltip="<p>Get priority handling in the support desk—faster response, faster resolution, and fewer blockers as you scale and run production workloads</p>">
                            Priority help desk
                        </div>
                        <div class="pricing-square-item highlight" data-faq-id="tb-cloud-white-labeling" data-tooltip="<p>White labeling lets you brand the platform as your own—use your logo, colors, and custom domain for a polished, client-ready experience that strengthens trust and keeps your brand front and center.\n You can add more devices anytime. After the 1,000 included devices, each additional device is $0.30 per month—so you can scale anytime.</p>">White labeling</div>
            ...
            <div class="pricing-section always-display active" id="monthly">
                <div class="cards-row flex-square">
                    <div class="pricing-square popular">
                        ...
                        <div class="pricing-square-item" data-faq-id="tb-private-cloud-how-are-datapoints-defined-and-metered" data-tooltip="<p>Up to 50,000 msg/min sustained (all protocols + integrations). A message = telemetry / RPC / attributes / downlink. Telemetry: 1 key/value = 1 data point; messages without measurements count as 1.</p>">50 000 msg/minute</div>
                        <div class="pricing-square-item" data-faq-id="tb-private-cloud-what-telemetry-storage-is-included-and-what-data-consumes-it" data-tooltip="<p>Includes 500 GB to store your platform data (telemetry, attributes, events, files). Near the limit: prune old data, add storage, or upgrade plan.</p>">500 GB of storage included</div>
                        <div class="pricing-square-item plus-icon highlight" data-faq-id="tb-private-cloud-what-happens-if-i-exceed-my-included-device-limit" data-tooltip="<p>You can add more devices anytime. After 5,000 included devices, extra devices are $0.10 per device per month.</p>">$0.10 per extra device</div>
                    </div>
                    <div class="pricing-square">
                        <h2>Growth</h2>
                        <div class="pricing-square-description">
                        ...
                        <div class="pricing-square-item">99.9% uptime guarantee </div>
                        <div class="pricing-square-item" data-faq-id="tb-private-cloud-how-are-datapoints-defined-and-metered" data-tooltip="<p>Up to 100,000 msg/min sustained (all protocols + integrations). A message = telemetry/RPC/attributes/downlink. Telemetry: 1 key/value = 1 data point; messages without measurements count as 1.</p>">100 000 msg/minute</div>
                        <div class="pricing-square-item" data-faq-id="tb-private-cloud-what-telemetry-storage-is-included-and-what-data-consumes-it" data-tooltip="<p>Includes 1 TB to store your platform data (telemetry, attributes, events, files). Near the limit: prune old data, add storage, or upgrade plan.</p>">1 TB of storage included</div>
                        <div class="pricing-square-item plus-icon highlight" data-faq-id="tb-private-cloud-what-happens-if-i-exceed-my-included-device-limit" data-tooltip="<p>You can add more devices anytime. After 25,000 included devices, extra devices are $0.09 per device per month.</p>">$0.09 per extra device</div>
                    </div>
                    <div class="pricing-square">
                        <h2>Scale</h2>
                        <div class="pricing-square-description">
                        ...
                        <div class="pricing-square-item" data-faq-id="tb-private-cloud-how-are-datapoints-defined-and-metered" data-tooltip="<p>Up to 500,000 msg/min sustained (all protocols + integrations). A message = telemetry/RPC/attributes/downlink. Telemetry: 1 key/value = 1 data point; messages without measurements count as 1.</p>">500 000 msg/minute</div>
                        <div class="pricing-square-item" data-faq-id="tb-private-cloud-what-telemetry-storage-is-included-and-what-data-consumes-it" data-tooltip="<p>Includes 2 TB to store your platform data (telemetry, attributes, events, files). Near the limit: prune old data, add storage, or upgrade plan.</p>">2 TB of storage included</div>
                        <div class="pricing-square-item plus-icon highlight" data-faq-id="tb-private-cloud-what-happens-if-i-exceed-my-included-device-limit" data-tooltip="<p>You can add more devices anytime. After 50,000 included devices, extra devices are $0.08 per device per month.</p>">$0.08 per extra device</div>
                    </div>
                    <div class="pricing-square">
                        <h2>Enterprise</h2>
                        <div class="pricing-square-description">
                        ...
                        <h4 class="pricing-square-price always-display">
                            Custom <span data-faq-id="tb-private-cloud-what-features-are-unique-to-the-enterprise-plan" data-faq-link-size="70%" data-tooltip="<p>Enterprise pricing built around your scale. Share your devices, msg/min, and retention and we’ll right-size the architecture and quote the best-fit package.</p>"></span>
                        </h4>
                        <div>
                        ...
                        <div class="pricing-square-item plus-icon highlight" data-faq-id="tb-private-cloud-what-happens-if-i-exceed-my-included-device-limit" data-tooltip="<p>Need more than 100,000 devices? Extra devices are < $0.05/device/month — contact us for the best rate.</p>"><$0.05 per extra device</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col d-flex justify-content-end">
                <div class="solution-selector">
                    <div id="Pricing_PE_SM_PayAsYouGo"
                        ...
                        <h3 id="Pricing_PE_SM_PayAsYouGo" class="gtm_button" data-tooltip="<p>Pay-as-you-go is a flexible monthly subscription. Scale up as you grow and pay for the capacity you need (tiers based on devices/assets).</p>" data-faq-id="pe-pay-as-you-go-self-managed-subscription-plans" data-faq-link-size="70%">Pay-as-you-go</h3>
                    </div>
                    <div id="Pricing_PE_SM_Perpetual"
                        ...
                        <h3 id="Pricing_PE_SM_Perpetual" class="gtm_button" data-tooltip="<p>Perpetual is a one-time license that turns your IoT platform into a long-term asset—predictable costs, full control of your roadmap, and a strong foundation for enterprise scale.</p>" data-faq-id="pe-perpetual-perpetual-meaning" data-faq-link-size="70%">Perpetual</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="pricing-section pricing-pay-as-you-go active" id="payAsYouGo">
                <div class="cards-row margin-bottom">
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item" data-faq-id="pe-pay-as-you-go-support-included" data-tooltip="<p>Get help through our community channel <a href='https://github.com/thingsboard/thingsboard/issues' target='_blank'>on GitHub</a></p>">
                            Community support
                        </div>
                        <div class="pricing-square-item no-icon">&nbsp;</div>
                        <div class="pricing-square-item no-icon">&nbsp;</div>
                    ...
                    <div class="pricing-square popular">
                        ...
                        <div class="pricing-square-item">100 assets</div>
                        <div class="pricing-square-item">1 production instance</div>
                        <div class="pricing-square-item" data-faq-id="pe-pay-as-you-go-support-included" data-tooltip="<p>Get access to our official support desk for product questions and troubleshooting—so you can resolve issues faster and keep your rollout on track.</p>">
                            Help desk
                        </div>
                    ...
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item" data-faq-id="pe-pay-as-you-go-support-included" data-tooltip="<p>Get priority handling in the support desk—faster response, faster resolution, and fewer blockers as you scale and run production workloads</p>">
                            Priority help desk
                        </div>
                        <div class="pricing-square-item highlight">White labeling</div>
                        <div class="pricing-square-item no-icon">&nbsp;</div>
