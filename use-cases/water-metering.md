...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/water-metering/wm1.png" />
    </div>
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/water-metering/wm2.png" />
    </div>
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/water-metering/wm3.png" />
    </div>
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/water-metering/wm4.png" />
    </div>
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/water-metering/wm5.png" />
    </div>
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/water-metering/wm6.png" />
    </div>
</div>
