...
<div class="case-studies-wrapper">
    ...
    <section id="case-studies-clients">
        <div class="client-card" data-category="Cold chain monitoring">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/ariot.webp');">
                <a class="content" href="/case-studies/ariot">
                    <img style="height: 75px" class="logo" src="https://img.thingsboard.io/case-studies/ariot.svg" title="ARIOT IOT TEKNOLOJILERI" alt="ARIOT IOT TEKNOLOJILERI logo">
        ...
        <div class="client-card" data-category="Smart city">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%),url('https://img.thingsboard.io/case-studies/kiotera.webp');">
                <a class="content" href="/case-studies/kiotera">
                    <img class="logo" src="https://img.thingsboard.io/case-studies/kiotera.svg" title="KIOTERA" alt="KIOTERA logo">
        ...
        <div class="client-card" data-category="Smart IoT solution">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/onedata.webp');">
                <a class="content" href="/case-studies/onedata">
                    <img class="logo" src="https://img.thingsboard.io/case-studies/onedata.svg" title="OneData" alt="OneData logo">
        ...
        <div class="client-card" data-category="Smart city">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/x-telia.webp');">
                <a class="content" href="/case-studies/xtelia">
                    <img style="height: 35px" class="logo" src="https://img.thingsboard.io/case-studies/x-telia.svg" title="X-TELIA" alt="X-TELIA logo">
        ...
        <div class="client-card" data-category="Smart IoT solution">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/lumen.webp');">
                <a class="content" href="/case-studies/lumen">
                    <img class="logo" src="https://img.thingsboard.io/case-studies/lumen.svg" title="Lumen Energy Solutions" alt="Lumen Energy Solutions logo">
        ...
        <div class="client-card" data-category="Smart energy">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/energenix.webp');">
                <a class="content" href="/case-studies/energenix">
                    <img class="logo" src="https://img.thingsboard.io/case-studies/energenix.svg" title="Energenix" alt="Energenix logo">
        ...
        <div class="client-card" data-category="Smart energy">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/energroup.webp');">
                <a class="content" href="/case-studies/energroup">
                    <img style="height: 65px" class="logo" src="https://img.thingsboard.io/case-studies/energroup.svg" title="EnerGroup" alt="EnerGroup logo">
        ...
        <div class="client-card" data-category="Industry 4.0">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/dacor.webp');">
                <a class="content" href="/case-studies/dacor">
                    <img class="logo" src="https://img.thingsboard.io/case-studies/dacor.svg" title="süc//dacor GmbH" alt="süc//dacor GmbH logo">
        ...
        <div class="client-card" data-category="Industry 4.0">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/crai.webp');">
                <a class="content" href="/case-studies/crai">
                    <img style="height: 65px" class="logo" src="https://img.thingsboard.io/case-studies/crai.svg" title="CRAI Automatización" alt="CRAI Automatización logo">
        ...
        <div class="client-card" data-category="Smart city">
            <div class="bg-wrap" style="background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://img.thingsboard.io/case-studies/iioote.webp');">
                <a class="content" href="/case-studies/iioote">
                    <img style="height: 35px" class="logo" src="https://img.thingsboard.io/case-studies/iioote.svg" title="iiOOTE" alt="iiOOTE logo">
