...
<div class="case-study-page-wrapper">
    <section class="case-study-hero">
        <div class="card">
            <div class="text">
                ...
                <div class="image inner" style="background-image: url('https://img.thingsboard.io/case-studies/energenix.webp')">
                    <img src="https://img.thingsboard.io/case-studies/energenix.svg" title="Energenix" alt="Energenix logo" width="200" height="56">
                </div>
            ...
            <div class="image large" style="background-image: url('https://img.thingsboard.io/case-studies/energenix.webp')">
                <img src="https://img.thingsboard.io/case-studies/energenix.svg" title="Energenix" alt="Energenix logo" width="200" height="56">
            </div>
        </div>
    </section>
    ...
    <section class="authored-quote">
        <img class="h-auto" src="https://img.thingsboard.io/case-studies/samantha-epa.webp" title="General Manager – Solar, Windforce PL, Samantha Epa" alt="Samantha Epa" width="658" height="424">
        <div class="text">
            <h2>Energenix</h2>
    ...
    <section class="tb-power mb">
        ...
        <div class="block">
            ...
            <img src="https://img.thingsboard.io/case-studies/energenix-1.webp" title="Unified asset & device management" alt="Unified asset & device management" width="450" height="250">
        </div>
        <div class="block">
            <div class="text">
            ...
            <img src="https://img.thingsboard.io/case-studies/energenix-2.webp" title="Real-time monitoring & visualization" alt="Real-time monitoring & visualization" width="450" height="240">
        </div>
        <div class="block">
            <div class="text">
            ...
            <img src="https://img.thingsboard.io/case-studies/energenix-3.webp" title="Advanced rule engine & alerts" alt="Advanced rule engine & alerts" width="450" height="240">
        </div>
        <div class="block">
            <div class="text">
            ...
            <img src="https://img.thingsboard.io/case-studies/energenix-4.webp" title="Fast on-site control with ThingsBoard Edge" alt="Fast on-site control with ThingsBoard Edge" width="450" height="250">
        </div>
        <div class="block">
            <div class="text">
            ...
            <img src="https://img.thingsboard.io/case-studies/energenix-5.webp" title="Edge + Cloud for mission-critical reliability" alt="Edge + Cloud for mission-critical reliability" width="450" height="240">
        </div>
    </section>
    ...
    <section class="tb-help">
        ...
        <div class="block">
            ...
            <div class="image-container">
                <img src="https://img.thingsboard.io/case-studies/digital_gauges.webp" title="Thingsboard digital gauges widgets" alt="Thingsboard digital gauges widgets" width="388" height="388">
        ...
        <div class="block">
            ...
            <div class="image-container">
                <img src="https://img.thingsboard.io/case-studies/tb-logo-card.webp" title="Thingsboard logo card" alt="Thingsboard logo card" width="388" height="388">
                <img src="https://img.thingsboard.io/case-studies/energenix-logo-card.webp" title="Energenix logo card" alt="Energenix logo card" width="388" height="388">
            </div>
        </div>
        {% include services-banner.liquid %}
    </section>
    <section class="authored-quote">
        <img class="h-auto" src="https://img.thingsboard.io/case-studies/Anuruddha_Tennakoon-Migara_Amithodhana.webp" title="Anuruddha Tennakoon and Migara Amithodhana" alt="Anuruddha Tennakoon and Migara Amithodhana" width="658" height="424">
        <div class="text">
            <h2>Conclusion</h2>
