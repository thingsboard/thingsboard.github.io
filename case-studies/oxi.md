...
<div class="case-study-page-wrapper">
    ...
    <section class="tb-power">
        ...
        <div class="block">
            ...
            <img src="https://img.thingsboard.io/case-studies/pellet-burner-operations.webp" title="Customized IoT backbone for pellet burner operations" alt="Pellets pile" width="900" height="480">
        </div>
        <div class="block">
            <div class="text">
            ...
            <img src="https://img.thingsboard.io/case-studies/device-provisionig.webp" title="Seamless and scalable device provisioning" alt="Laptop" width="900" height="480">
        </div>
        <div class="block">
            <div class="text">
            ...
            <img src="https://img.thingsboard.io/case-studies/role-based-access.webp" title="Role-based access for the entire distribution network" alt="Virtual hierarchy" width="900" height="480">
        </div>
        <div class="block">
            <div class="text">
            ...
            <img src="https://img.thingsboard.io/case-studies/real-time-monitoring.webp" title="Real-time monitoring and remote control via dashboards" alt="Hands with tablet" width="900" height="480">
        </div>
        <div class="block">
            <div class="text">
