...
* Core & Rule Engine:
  * [#6536](https://github.com/thingsboard/thingsboard/pull/6536) Fix misc cache issues with race conditions;
  * [#6910](https://github.com/thingsboard/thingsboard/pull/6910) Mail server timeout implementation;
  * [#6535](https://github.com/thingsboard/thingsboard/pull/6535) Fix for handling alarm deletion and attributes deletion in DeviceState;
  * [#4666](https://github.com/thingsboard/thingsboard/issues/4666) Fix encoding of request params in the Rest API call rule node;
  * [#6315](https://github.com/thingsboard/thingsboard/issues/6315) Fix kafka rule node;
  * [#6323](https://github.com/thingsboard/thingsboard/issues/6323) Fix entity views caching;
  * [#6330](https://github.com/thingsboard/thingsboard/pull/6330) Fix SQL error on reinstall;
  * [#6446](https://github.com/thingsboard/thingsboard/pull/6446) Fix method to upload OTA binary file via Swagger ui;
  * [#6642](https://github.com/thingsboard/thingsboard/pull/6642) Fix permission checks for getDeviceProfileInfoById REST API call;
  * [#6421](https://github.com/thingsboard/thingsboard/issues/6421) Fix NPE in 'copy to view' rule node;
  * [#6682](https://github.com/thingsboard/thingsboard/pull/6682) Fix slow queries logging;
  ...
  * [#6901](https://github.com/thingsboard/thingsboard/pull/6901/files) Fixed device & device-profile validation;
  * [#6929](https://github.com/thingsboard/thingsboard/pull/6929) Removed 'isolated tb-core' flag in tenant profile;
  * [#6931](https://github.com/thingsboard/thingsboard/pull/6931) Fix export/Import RuleChain for nested RuleChains;
  * [#6937](https://github.com/thingsboard/thingsboard/pull/6937) Fix transport statistics logging;
  * [#6939](https://github.com/thingsboard/thingsboard/pull/6939) Single Partition for Kafka response topics;
* UI:
  * [#6886](https://github.com/thingsboard/thingsboard/pull/6886) Fix double click zooming on map widgets;
  * [#6495](https://github.com/thingsboard/thingsboard/issues/6495) Fix Trip Animation widget bug. See also [#6496](https://github.com/thingsboard/thingsboard/pull/6496);
  * [#6651](https://github.com/thingsboard/thingsboard/issues/6651) Fix Date Range navigator widget date selection; 
  * [#6671](https://github.com/thingsboard/thingsboard/issues/6671) Fix visual bugs in pie flot widget;
  * [#6141](https://github.com/thingsboard/thingsboard/issues/6141) Fix resize in Knob Control widget;  
  * [#6475](https://github.com/thingsboard/thingsboard/pull/6475) Fixed entities table manual sort if pagination disabled;
  * [#6462](https://github.com/thingsboard/thingsboard/pull/6462) Fix displaying 'Unit title' and 'value timestamp' for Digital gauges widgets;
  * [#6298](https://github.com/thingsboard/thingsboard/pull/6298) Fix UI build according to new [github policy](https://github.blog/2021-09-01-improving-git-protocol-security-github/);
  * [#6321](https://github.com/thingsboard/thingsboard/pull/6321) Fix bug in zooming of the Image Map;
  * [#6339](https://github.com/thingsboard/thingsboard/pull/6339) Fix UI build in Windows OS;
  * [#6349](https://github.com/thingsboard/thingsboard/issues/6349) Fixed duplicated dialogs on redirect;
  ...
  * [#6690](https://github.com/thingsboard/thingsboard/pull/6690) Fix bug with incorrect display of delayed status;
  ...
  * [#6514](https://github.com/thingsboard/thingsboard/issues/6514) Fix pagination for edge downlink table;
  * [#6769](https://github.com/thingsboard/thingsboard/pull/6769) Fix incorrect label in tenant profile;
  * [#6774](https://github.com/thingsboard/thingsboard/issues/6774) Fix permission check in show alarm details;
  ...
  * [#6916](https://github.com/thingsboard/thingsboard/pull/6916) Fix tooltip actions that contains space in name for map widgets;
  * [#6936](https://github.com/thingsboard/thingsboard/pull/6936) Fix import/export/copy operations for alarm type widgets;
* Edge:
  ...
  * [#6699](https://github.com/thingsboard/thingsboard/pull/6699) Fix validation of missing rule chain;
