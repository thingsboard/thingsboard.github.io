...
persistent-session-demo:
  0:
    image: https://img.thingsboard.io/mqtt-broker/user-guide/ui/persistent-session-demo-1.png
  ...
  1:
    image: https://img.thingsboard.io/mqtt-broker/user-guide/ui/persistent-session-demo-2.png
    title: 'Add a subscription to a topic "session/persistent" with QoS 1.'
  2:
    image: https://img.thingsboard.io/mqtt-broker/user-guide/ui/persistent-session-demo-3.png
    title: 'Click the "Disconnect" button.'
  3:
    image: https://img.thingsboard.io/mqtt-broker/user-guide/ui/persistent-session-demo-4.png
    title: 'Switch to another Client and publish several messages to the topic "session/persistent".'
  4:
    image: https://img.thingsboard.io/mqtt-broker/user-guide/ui/persistent-session-demo-5.png
    title: 'Switch back to the "Persistent session demo" Client and click "Connect".'
  5:
    image: https://img.thingsboard.io/mqtt-broker/user-guide/ui/persistent-session-demo-6.png
