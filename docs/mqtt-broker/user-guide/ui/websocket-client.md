...
ws-connection-will:
  ...
  1:
    ...
    title: 'Last will settings, available if selected MQTT v.5'
  2:
    image: /images/mqtt-broker/user-guide/ui/ws-connection-will-3.png
...
ws-connection-edit:
  ...
  1:
    ...
    title: 'Click on the pencil icon of the connection you wish to edit.'
...
ws-connection-delete:
  ...
  1:
    ...
    title: 'Click on the trash icon of the connection you wish to delete.'
  2:
    image: /images/mqtt-broker/user-guide/ui/ws-connection-delete-3.png
...
ws-subscription-edit:
  0:
    ...
    title: 'On the WebSocket Client page click on the pencil button on the subscription row.'
