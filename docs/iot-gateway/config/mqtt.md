...
| mapping[].attributes[].keySource      | (Optional) Source for attribute key name. Can be: `message` (default) or `topic`. See [Usage examples](/docs/iot-gateway/config/mqtt/#usage-examples) for more information.                                                              |
...
| mapping[].timeseries[].keySource      | (Optional) Source for time series key name. Can be: `message` (default) or `topic`. See [Usage examples](/docs/iot-gateway/config/mqtt/#usage-examples) for more information.                                                            |
