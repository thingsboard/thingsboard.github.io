...
**Since 3.2.2,** you can set a dashboard as your home screen. To do so, you should enter your profile settings by clicking three dots in the upper right corner of the screen.
There, find the _Home dashboard_ bar, and from the drop-down menu, select the dashboard to be set as a home view. Once selected, click "Save" in the lower right corner of the profile dialog box.
To see your new home screen, select the Home option from the main menu on the left.
