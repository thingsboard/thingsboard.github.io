...
{% include code.html file="resources/4.0.1/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/4.0.1/thingsboard-centos-installation.sh" language="shell" %}
