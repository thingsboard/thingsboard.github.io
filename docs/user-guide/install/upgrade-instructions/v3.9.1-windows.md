...
description: ThingsBoard upgrade guide for Windows - v3.9.1
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.9. In order to upgrade to 3.9.1 you need to [**upgrade to 3.9 first**](/docs/user-guide/install/upgrade-instructions/v3.9.0-windows/).
{% endcapture %}
