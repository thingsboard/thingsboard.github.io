---
layout: docwithnav
title: ThingsBoard CE v4.1.x upgrade instructions for Ubuntu
description: ThingsBoard CE v4.1.x upgrade guide for Ubuntu
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 4.0.x. In order to upgrade to 4.1 you need to [**upgrade to 4.0.x first**](/docs/user-guide/install/upgrade-instructions/ubuntu/v4-0-x/#upgrading-thingsboard-ce-to-400).
{% endcapture %}
