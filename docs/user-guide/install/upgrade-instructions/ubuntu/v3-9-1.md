...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.9. In order to upgrade to 3.9.1 you need to [**upgrade to 3.9 first**](/docs/user-guide/install/upgrade-instructions/ubuntu/v3-9-0/).
{% endcapture %}
