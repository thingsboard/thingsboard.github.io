---
layout: docwithnav
title: ThingsBoard CE v3.6.x upgrade instructions for Ubuntu
description: ThingsBoard CE v3.6.x upgrade guide for Ubuntu
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.5.1. In order to upgrade to 3.6 you need to [**upgrade to 3.5.1 first**](/docs/user-guide/install/upgrade-instructions/ubuntu/v3-5-x/#upgrading-thingsboard-ce-to-351).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
