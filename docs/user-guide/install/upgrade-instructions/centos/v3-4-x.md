...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.3.4.1. In order to upgrade to 3.4 you need to [**upgrade to 3.3.4.1 first**](#upgrading-thingsboard-ce-to-3341).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
