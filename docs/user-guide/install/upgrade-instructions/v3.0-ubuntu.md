---
layout: docwithnav
title: Upgrade to v3.0 (Ubuntu)
description: ThingsBoard upgrade guide for Ubuntu - v3.0
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
```bash
{% include_relative resources/3.0.0/thingsboard-ubuntu-download.sh %}
```
{: .copy-code}  
...
```bash
{% include_relative resources/3.0.0/thingsboard-ubuntu-installation.sh %}
```
{: .copy-code}
