...
description: ThingsBoard upgrade guide for Centos - v3.3
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.2.2. In order to upgrade to 3.3 you need to [**upgrade to 3.2.2 first**](/docs/user-guide/install/upgrade-instructions/v3.2.2-centos/).

#### ThingsBoard package download

```bash
{% include_relative resources/3.3/thingsboard-centos-download.sh %}
```
{: .copy-code}
...
```bash
{% include_relative resources/3.3/thingsboard-centos-installation.sh %}
```
{: .copy-code}
