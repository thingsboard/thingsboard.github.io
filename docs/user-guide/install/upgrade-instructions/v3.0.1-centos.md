...
description: ThingsBoard upgrade guide for Centos - v3.0.1
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.0. In order to upgrade to 3.0.1 you need to [**upgrade to 3.0 first**](/docs/user-guide/install/upgrade-instructions/v3.0-centos/).
...
```bash
{% include_relative resources/3.0.1/thingsboard-centos-download.sh %}
```
{: .copy-code}  
...
```bash
{% include_relative resources/3.0.1/thingsboard-centos-installation.sh %}
```
{: .copy-code}
