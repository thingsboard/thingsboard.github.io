...
{% include code.html file="resources/3.4.2/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/3.4.2/thingsboard-centos-installation.sh" language="shell" %}
