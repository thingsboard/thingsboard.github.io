...
{% include code.html file="resources/3.7/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/3.7/thingsboard-centos-installation.sh" language="shell" %}
