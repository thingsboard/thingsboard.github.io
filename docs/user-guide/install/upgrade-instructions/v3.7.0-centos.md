---
layout: docwithnav
title: Upgrade to v3.7 (Centos)
description: ThingsBoard upgrade guide for Centos - v3.7
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.6.4. In order to upgrade to 3.7 you need to [**upgrade to 3.6.4 first**](/docs/user-guide/install/upgrade-instructions/v3.6.4-centos/).
{% endcapture %}
...
```bash
{% include_relative resources/3.7/thingsboard-centos-download.sh %}
```
{: .copy-code}
...
```bash
{% include_relative resources/3.7/thingsboard-centos-installation.sh %}
```
{: .copy-code}
