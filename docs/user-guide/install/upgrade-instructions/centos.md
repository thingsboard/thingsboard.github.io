---
layout: docwithnav
title: ThingsBoard upgrade instructions for CentOS
description: ThingsBoard upgrade guide for CentOS
hidetoc: true
breadcrumbs: true
breadcrumbs-steps: 1
...
{% include resources.liquid version="3.3.4" kind="centos-download" %}
...
{% include resources.liquid version="3.3.4" kind="centos-installation" %}
...
{% include resources.liquid version="3.2.2" kind="centos-download" %}  
...
{% include resources.liquid version="3.2.2" kind="centos-installation" %}
...
{% include resources.liquid version="3.2.1" kind="centos-download" %}  
...
{% include resources.liquid version="3.2.1" kind="centos-installation" %}
...
{% include resources.liquid version="3.1.1" kind="centos-download" %}  
...
{% include resources.liquid version="3.1.1" kind="centos-installation" %}
...
{% include resources.liquid version="3.1" kind="centos-download" %}  
...
{% include resources.liquid version="3.1" kind="centos-installation" %}
...
{% include resources.liquid version="3.0.1" kind="centos-download" %}  
...
{% include resources.liquid version="3.0.1" kind="centos-installation" %}
...
{% include resources.liquid version="3.0.0" kind="centos-download" %}  
...
{% include resources.liquid version="3.0.0" kind="centos-installation" %}
