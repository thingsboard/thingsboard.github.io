...
description: ThingsBoard upgrade guide for Ubuntu - v3.4.2
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.4.1. In order to upgrade to 3.4.2 you need to [**upgrade to 3.4.1 first**](/docs/user-guide/install/upgrade-instructions/v3.4.1-ubuntu/).
{% endcapture %}
...
```bash
{% include_relative resources/3.4.2/thingsboard-ubuntu-download.sh %}
```
{: .copy-code}
...
```bash
{% include_relative resources/3.4.2/thingsboard-ubuntu-installation.sh %}
```
{: .copy-code}
