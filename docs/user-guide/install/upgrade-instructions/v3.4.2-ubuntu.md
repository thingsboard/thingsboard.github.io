...
{% include code.html file="resources/3.4.2/thingsboard-ubuntu-download.sh" language="shell" %}
...
{% include code.html file="resources/3.4.2/thingsboard-ubuntu-installation.sh" language="shell" %}
