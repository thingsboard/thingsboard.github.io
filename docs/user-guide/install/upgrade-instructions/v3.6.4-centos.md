...
{% include code.html file="resources/3.6.4/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/3.6.4/thingsboard-centos-installation.sh" language="shell" %}
