...
{% include code.html file="resources/3.9/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/3.9/thingsboard-centos-installation.sh" language="shell" %}
