...
description: ThingsBoard upgrade guide for Centos - v3.3.2
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.3.1. In order to upgrade to 3.3.2 you need to [**upgrade to 3.3.1 first**](/docs/user-guide/install/upgrade-instructions/v3.3.1-centos/).

#### ThingsBoard package download

```bash
{% include_relative resources/3.3.2/thingsboard-centos-download.sh %}
```
{: .copy-code}
...
```bash
{% include_relative resources/3.3.2/thingsboard-centos-installation.sh %}
```
{: .copy-code}
