...
{% include code.html file="resources/3.9.1/thingsboard-ubuntu-download.sh" language="shell" %}
...
{% include code.html file="resources/3.9.1/thingsboard-ubuntu-installation.sh" language="shell" %}
