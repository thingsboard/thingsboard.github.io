...
{% include code.html file="resources/3.4.4/thingsboard-ubuntu-download.sh" language="shell" %}
...
{% include code.html file="resources/3.4.4/thingsboard-ubuntu-installation.sh" language="shell" %}
