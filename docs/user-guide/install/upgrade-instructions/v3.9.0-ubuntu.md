...
{% include code.html file="resources/3.9/thingsboard-ubuntu-download.sh" language="shell" %}
...
{% include code.html file="resources/3.9/thingsboard-ubuntu-installation.sh" language="shell" %}
