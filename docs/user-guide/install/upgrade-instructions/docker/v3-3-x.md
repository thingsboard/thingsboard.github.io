...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.2.2. In order to upgrade to 3.3 you need to [**upgrade to 3.2.2 first**](/docs/ce/user-guide/install/upgrade-instructions/docker/v3-2-x/#upgrading-thingsboard-ce-to-322).
