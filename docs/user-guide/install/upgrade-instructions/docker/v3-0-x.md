---
layout: docwithnav
title: ThingsBoard CE v3.0.x upgrade instructions for Docker
description: ThingsBoard CE v3.0.x upgrade guide for Docker
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.0. In order to upgrade to 3.0.1 you need to [**upgrade to 3.0CE first**](#upgrading-thingsboard-ce-to-30).
