...
description: ThingsBoard upgrade guide for Ubuntu - v3.2.2
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.2.1. In order to upgrade to 3.2.2 you need to [**upgrade to 3.2.1 first**](/docs/user-guide/install/upgrade-instructions/v3.2.1-ubuntu/).
