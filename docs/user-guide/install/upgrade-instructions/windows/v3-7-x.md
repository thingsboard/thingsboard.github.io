...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.6.4. In order to upgrade to 3.7 you need to [**upgrade to 3.6.4 first**](/docs/user-guide/install/upgrade-instructions/windows/v3-6-x/#upgrading-thingsboard-ce-to-364).
{% endcapture %}
