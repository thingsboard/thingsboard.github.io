---
layout: docwithnav
title: ThingsBoard CE v4.1.x upgrade instructions for Docker Compose
description: ThingsBoard CE v4.1.x upgrade guide for Docker Compose
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 4.0.x. In order to upgrade to 4.1 you need to [**upgrade to 4.0.x first**](/docs/user-guide/install/upgrade-instructions/docker-compose/v4-0-x/#upgrading-thingsboard-ce-to-400).
<br>
{% endcapture %}
...
{% include docs/user-guide/install/docker-compose-upgrade-steps.md version="4.1.0" %}
