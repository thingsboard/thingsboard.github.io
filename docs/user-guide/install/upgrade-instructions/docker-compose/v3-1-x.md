...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.0.1. In order to upgrade to 3.1 you need to [**upgrade to 3.0.1 first**](/docs/ce/user-guide/install/upgrade-instructions/docker-compose/v3-0-x/#upgrading-thingsboard-ce-to-301).
