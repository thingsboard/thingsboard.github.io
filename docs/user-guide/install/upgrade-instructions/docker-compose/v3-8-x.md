---
layout: docwithnav
title: ThingsBoard CE v3.8.x upgrade instructions for Docker Compose
description: ThingsBoard CE v3.8.x upgrade guide for Docker Compose
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.7. In order to upgrade to 3.8 you need to [**upgrade to 3.7 first**](/docs/ce/user-guide/install/upgrade-instructions/docker-compose/v3-7-x/#upgrading-thingsboard-ce-to-370).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
