---
layout: docwithnav
title: ThingsBoard CE v3.7.x upgrade instructions for Docker Compose
description: ThingsBoard CE v3.7.x upgrade guide for Docker Compose
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.6.4. In order to upgrade to 3.7 you need to [**upgrade to 3.6.4 first**](/docs/ce/user-guide/install/upgrade-instructions/docker-compose/v3-6-x/#upgrading-thingsboard-ce-to-364).
{% endcapture %}
