...
description: ThingsBoard upgrade guide for Centos - v3.0
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
```bash
{% include_relative resources/3.0.0/thingsboard-centos-download.sh %}
```
{: .copy-code}  
...
```bash
{% include_relative resources/3.0.0/thingsboard-centos-installation.sh %}
```
{: .copy-code}
