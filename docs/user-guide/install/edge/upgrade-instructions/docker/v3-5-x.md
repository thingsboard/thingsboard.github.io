...
title: ThingsBoard Edge CE v3.5.x upgrade instructions for Docker
description: ThingsBoard Edge CE v3.5.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-5-x/#upgrading-thingsboard-ce-to-351" %}
...
{% assign updateServerLink = "docker/v3-5-x/#upgrading-thingsboard-ce-to-350" %}
{% include templates/edge/install/compatibility-warning-version.md %}
{% capture edge-previousVersion %}
These steps are applicable for Edge {{previousVersion}} version.
{% endcapture %}
