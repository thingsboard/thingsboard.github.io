...
title: ThingsBoard Edge CE v3.7.x upgrade instructions for Ubuntu
description: ThingsBoard Edge CE v3.7.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-7-x/#upgrading-thingsboard-ce-to-37" %}
