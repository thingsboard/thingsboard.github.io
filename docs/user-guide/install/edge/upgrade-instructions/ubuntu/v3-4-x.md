...
title: ThingsBoard Edge CE v3.4.x upgrade instructions for Ubuntu
description: ThingsBoard Edge CE v3.4.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-4-x/#upgrading-thingsboard-ce-to-343" %}
...
{% assign updateServerLink = "ubuntu/v3-4-x/#upgrading-thingsboard-ce-to-341" %}
...
{% assign updateServerLink = "ubuntu/v3-4-x/#upgrading-thingsboard-ce-to-34" %}
