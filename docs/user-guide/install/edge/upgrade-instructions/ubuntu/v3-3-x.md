...
title: ThingsBoard Edge CE v3.3.x upgrade instructions for Ubuntu
description: ThingsBoard Edge CE v3.3.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-3-x/#upgrading-thingsboard-ce-to-3341" %}
