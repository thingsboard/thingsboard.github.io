...
title: ThingsBoard Edge CE v4.0.x upgrade instructions for Ubuntu
description: ThingsBoard Edge CE v4.0.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v4-0-x/#upgrading-thingsboard-ce-to-401" %}
