...
title: ThingsBoard Edge CE v4.0.x upgrade instructions for CentOS
description: ThingsBoard Edge CE v4.0.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v4-0-x/#upgrading-thingsboard-ce-to-401" %}
