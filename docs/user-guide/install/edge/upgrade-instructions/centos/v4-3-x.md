...
{% assign updateServerLink = "centos/v4-3-x/#upgrading-thingsboard-ce-to-43" %}
...
```bash
wget https://github.com/thingsboard/thingsboard-edge/releases/download/v4.3/tb-edge-4.3.rpm
```
{: .copy-code}
