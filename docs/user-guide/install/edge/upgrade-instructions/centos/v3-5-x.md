...
title: ThingsBoard Edge CE v3.5.x upgrade instructions for CentOS
description: ThingsBoard Edge CE v3.5.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v3-5-x/#upgrading-thingsboard-ce-to-3511" %}
...
{% assign updateServerLink = "centos/v3-5-x/#upgrading-thingsboard-ce-to-351" %}
...
{% assign updateServerLink = "centos/v3-5-x/#upgrading-thingsboard-ce-to-35" %}
