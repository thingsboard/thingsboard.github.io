...
title: ThingsBoard Edge CE v3.7.x upgrade instructions for CentOS
description: ThingsBoard Edge CE v3.7.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v3-7-x/#upgrading-thingsboard-ce-to-37" %}
...
```bash
wget https://github.com/thingsboard/thingsboard-edge/releases/download/v3.7/tb-edge-3.7.rpm
```
{: .copy-code}
