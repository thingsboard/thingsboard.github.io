...
Download ThingsBoard Edge package for Windows: [tb-edge-windows-4.3.0.1.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v4.3/tb-edge-windows-4.3.0.1.zip).
