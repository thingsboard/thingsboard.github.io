...
title: ThingsBoard Edge CE v3.9.x upgrade instructions for Windows
description: ThingsBoard Edge CE v3.9.x upgrade guide for Windows
...
{% assign updateServerLink = "windows/v3-9-x/#upgrading-thingsboard-ce-to-391" %}
...
{% assign updateServerLink = "windows/v3-9-x/#upgrading-thingsboard-ce-to-390" %}
