...
## Upgrading to 4.2EDGE {#upgrading-to-42}

{% assign serverVersion = "4.2" %}
{% assign updateServerLink = "#upgrading-to-42" %}
{% include templates/edge/install/compatibility-warning-version.md %}

### Ubuntu/CentOS/Raspberry Pi {#ubuntucentosrpi-42}

**NOTE**: These steps are applicable for ThingsBoard Edge 4.1EDGE version.

#### ThingsBoard Edge package download

{% capture tabspec %}tb-edge-download-4-2
tb-edge-download-4-2-ubuntu,Ubuntu/Raspberry Pi,shell,resources/4.2/tb-edge-ubuntu-download.sh,/docs/user-guide/install/edge/resources/4.2/tb-edge-ubuntu-download.sh
tb-edge-download-4-2-centos,CentOS,shell,resources/4.2/tb-edge-centos-download.sh,/docs/user-guide/install/edge/resources/4.2/tb-edge-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
{% capture tabspec %}tb-edge-installation-4-2
tb-edge-installation-4-2-ubuntu,Ubuntu/Raspberry Pi,shell,resources/4.2/tb-edge-ubuntu-installation.sh,/docs/user-guide/install/edge/resources/4.2/tb-edge-ubuntu-installation.sh
tb-edge-installation-4-2-centos,CentOS,shell,resources/4.2/tb-edge-centos-installation.sh,/docs/user-guide/install/edge/resources/4.2/tb-edge-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
_**NOTE**: These steps are applicable for ThingsBoard Edge 4.1EDGE version._
...
## Upgrading to 4.1EDGE {#upgrading-to-41}

{% assign serverVersion = "4.1" %}
{% assign updateServerLink = "#upgrading-to-41" %}
{% include templates/edge/install/compatibility-warning-version.md %}

### Ubuntu/CentOS/Raspberry Pi {#ubuntucentosrpi-41}

**NOTE**: These steps are applicable for ThingsBoard Edge 4.0.1EDGE version.

#### ThingsBoard Edge package download

{% capture tabspec %}tb-edge-download-4-1
tb-edge-download-4-1-ubuntu,Ubuntu/Raspberry Pi,shell,resources/4.1/tb-edge-ubuntu-download.sh,/docs/user-guide/install/edge/resources/4.1/tb-edge-ubuntu-download.sh
tb-edge-download-4-1-centos,CentOS,shell,resources/4.1/tb-edge-centos-download.sh,/docs/user-guide/install/edge/resources/4.1/tb-edge-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
{% capture tabspec %}tb-edge-installation-4-1
tb-edge-installation-4-1-ubuntu,Ubuntu/Raspberry Pi,shell,resources/4.1/tb-edge-ubuntu-installation.sh,/docs/user-guide/install/edge/resources/4.1/tb-edge-ubuntu-installation.sh
tb-edge-installation-4-1-centos,CentOS,shell,resources/4.1/tb-edge-centos-installation.sh,/docs/user-guide/install/edge/resources/4.1/tb-edge-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
_**NOTE**: These steps are applicable for ThingsBoard Edge 4.0.1EDGE version._
...
_**NOTE**: These steps are applicable for ThingsBoard Edge 3.9.1EDGE version._

#### ThingsBoard Edge package download

{% capture tabspec %}tb-edge-download-4-0-1
tb-edge-download-4-0-1-ubuntu,Ubuntu/Raspberry Pi,shell,resources/4.0.1/tb-edge-ubuntu-download.sh,/docs/user-guide/install/edge/resources/4.0.1/tb-edge-ubuntu-download.sh
tb-edge-download-4-0-1-centos,CentOS,shell,resources/4.0.1/tb-edge-centos-download.sh,/docs/user-guide/install/edge/resources/4.0.1/tb-edge-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
tb-edge-installation-4-0-1-ubuntu,Ubuntu/Raspberry Pi,shell,resources/4.0.1/tb-edge-ubuntu-installation.sh,/docs/user-guide/install/edge/resources/4.0.1/tb-edge-ubuntu-installation.sh
tb-edge-installation-4-0-1-centos,CentOS,shell,resources/4.0.1/tb-edge-centos-installation.sh,/docs/user-guide/install/edge/resources/4.0.1/tb-edge-centos-installation.sh{% endcapture %}
{% include tabs.html %}
