...
- Download [installation archive](https://github.com/thingsboard/thingsboard/releases/download/v1.2/thingsboard-windows-1.2.zip) or [build it from source](/docs/user-guide/install/building-from-source).
