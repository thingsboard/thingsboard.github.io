...
- Download [installation archive](https://github.com/thingsboard/thingsboard/releases/download/v2.3/thingsboard-windows-2.3.zip) or [build it from source](/docs/user-guide/install/building-from-source).
