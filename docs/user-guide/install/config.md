...
| database.entities.type           | Type of the entities database to use: sql or cassandra                                 | sql               | DATABASE_ENTITIES_TYPE            |
| database.ts.type                 | Type of the ts database to use: sql or cassandra (for hybrid mode, only this value should be cassandra) | sql | DATABASE_TS_TYPE |
