...
<ul id="markdown-toc">
    <li>
      <a href="#upgrading-to-421" id="markdown-toc-upgrading-to-421">Upgrading to 4.2.1</a>
      <ul>
          <li>
    ...
    <li>
      <a href="#upgrading-to-42" id="markdown-toc-upgrading-to-42">Upgrading to 4.2</a>
      <ul>
          <li>
...
## Upgrading to 4.2.1 {#upgrading-to-421}
...
thingsboard-download-4-2-1-ubuntu,Ubuntu,shell,resources/4.2.1/thingsboard-ubuntu-download.sh,/docs/user-guide/install/resources/4.2.1/thingsboard-ubuntu-download.sh
thingsboard-download-4-2-1-centos,CentOS,shell,resources/4.2.1/thingsboard-centos-download.sh,/docs/user-guide/install/resources/4.2.1/thingsboard-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
thingsboard-installation-4-2-1-ubuntu,Ubuntu,shell,resources/4.2.1/thingsboard-ubuntu-installation.sh,/docs/user-guide/install/resources/4.2.1/thingsboard-ubuntu-installation.sh
thingsboard-installation-4-2-1-centos,CentOS,shell,resources/4.2.1/thingsboard-centos-installation.sh,/docs/user-guide/install/resources/4.2.1/thingsboard-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 4.2.x. In order to upgrade to 4.2.1 you need to [**upgrade to 4.2.x first**](/docs/user-guide/install/upgrade-instructions/#windows-42).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
...
## Upgrading to 4.2 {#upgrading-to-42}
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 4.1.x. In order to upgrade to 4.2 you need to [**upgrade to 4.1.x first**](/docs/user-guide/install/upgrade-instructions/#ubuntucentos-41).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
...
thingsboard-download-4-2-ubuntu,Ubuntu,shell,resources/4.2/thingsboard-ubuntu-download.sh,/docs/user-guide/install/resources/4.2/thingsboard-ubuntu-download.sh
thingsboard-download-4-2-centos,CentOS,shell,resources/4.2/thingsboard-centos-download.sh,/docs/user-guide/install/resources/4.2/thingsboard-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
thingsboard-installation-4-2-ubuntu,Ubuntu,shell,resources/4.2/thingsboard-ubuntu-installation.sh,/docs/user-guide/install/resources/4.2/thingsboard-ubuntu-installation.sh
thingsboard-installation-4-2-centos,CentOS,shell,resources/4.2/thingsboard-centos-installation.sh,/docs/user-guide/install/resources/4.2/thingsboard-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
thingsboard-download-4-0-1-ubuntu,Ubuntu,shell,resources/4.0.1/thingsboard-ubuntu-download.sh,/docs/user-guide/install/resources/4.0.1/thingsboard-ubuntu-download.sh
thingsboard-download-4-0-1-centos,CentOS,shell,resources/4.0.1/thingsboard-centos-download.sh,/docs/user-guide/install/resources/4.0.1/thingsboard-centos-download.sh{% endcapture %}
{% include tabs.html %}
