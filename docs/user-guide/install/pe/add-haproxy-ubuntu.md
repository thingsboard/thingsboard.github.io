...
Ubuntu 18.04 hosted in the cloud with valid DNS name assigned to the instance. Cloud vendor network settings should allow connections on Port 80 (HTTP) and 443 (HTTPS). 
