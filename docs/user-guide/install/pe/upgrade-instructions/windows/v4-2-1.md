...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 4.2.xPE. In order to upgrade to 4.2.1PE you need to [**upgrade to 4.2PE first**](/docs/user-guide/install/pe/upgrade-instructions/windows/v4-2-0/).
{% endcapture %}
