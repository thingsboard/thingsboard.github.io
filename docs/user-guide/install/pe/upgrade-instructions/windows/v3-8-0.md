...
title: Upgrade to v3.8 (Windows)
description: ThingsBoard PE upgrade guide for Windows - v3.8
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.7PE. In order to upgrade to 3.8PE you need to [**upgrade to 3.7PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.7.0-windows/).
{% endcapture %}
