...
title: Upgrade to v3.3 (Ubuntu)
description: ThingsBoard PE upgrade guide for Ubuntu - v3.3
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.2.2PE. In order to upgrade to 3.3PE you need to [**upgrade to 3.2.2PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.2.2-ubuntu/).
