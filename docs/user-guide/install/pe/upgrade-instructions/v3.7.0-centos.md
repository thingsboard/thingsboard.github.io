...
{% include code.html file="resources/3.7pe/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/3.7pe/thingsboard-centos-installation.sh" language="shell" %}
