...
{% include code.html file="resources/3.9.1pe/thingsboard-ubuntu-download.sh" language="shell" %}
...
{% include code.html file="resources/3.9.1pe/thingsboard-ubuntu-installation.sh" language="shell" %}
