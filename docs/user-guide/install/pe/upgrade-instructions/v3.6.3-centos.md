...
{% include code.html file="resources/3.6.3pe/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/3.6.3pe/thingsboard-centos-installation.sh" language="shell" %}
