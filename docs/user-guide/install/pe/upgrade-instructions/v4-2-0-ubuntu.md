...
description: ThingsBoard PE upgrade guide for Ubuntu - v4.2
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 4.1.xPE. In order to upgrade to 4.2PE you need to [**upgrade to 4.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/v4.1.0-ubuntu/).
{% endcapture %}
