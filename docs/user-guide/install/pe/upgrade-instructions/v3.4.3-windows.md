...
title: Upgrade to v3.4.3 (Windows)
description: ThingsBoard PE upgrade guide for Windows - v3.4.3
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.4.2PE. In order to upgrade to 3.4.3PE you need to [**upgrade to 3.4.2PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.4.2-windows/).
{% endcapture %}
