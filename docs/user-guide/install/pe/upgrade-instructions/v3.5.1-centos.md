...
{% include code.html file="resources/3.5.1pe/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/3.5.1pe/thingsboard-centos-installation.sh" language="shell" %}
