...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.8.1PE. In order to upgrade to 3.9PE you need to [**upgrade to 3.8.1PE first**](#upgrading-thingsboard-pe-to-381).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
