...
title: Upgrade to v3.1 (Ubuntu)
description: ThingsBoard PE upgrade guide for Ubuntu - v3.1
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.0.1PE. In order to upgrade to 3.1PE you need to [**upgrade to 3.0.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.0.1-ubuntu/).
