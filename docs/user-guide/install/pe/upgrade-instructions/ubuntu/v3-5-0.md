...
title: Upgrade to v3.5 (Ubuntu)
description: ThingsBoard PE upgrade guide for Ubuntu - v3.5
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.4.4PE. In order to upgrade to 3.5PE you need to [**upgrade to 3.4.4PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.4.4-ubuntu/).
{% endcapture %}
