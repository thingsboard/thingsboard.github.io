...
description: ThingsBoard PE upgrade guide for Centos - v3.6.4
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.6.3PE. In order to upgrade to 3.6.4PE you need to [**upgrade to 3.6.3PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.6.3-centos/).
{% endcapture %}
...
```bash
{% include_relative resources/3.6.4pe/thingsboard-centos-download.sh %}
```
{: .copy-code}
...
```bash
{% include_relative resources/3.6.4pe/thingsboard-centos-installation.sh %}
```
{: .copy-code}
