...
title: Upgrade to v3.4.1 (Windows)
description: ThingsBoard PE upgrade guide for Windows - v3.4.1
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.4PE. In order to upgrade to 3.4.1PE you need to [**upgrade to 3.4PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.4-windows/).
{% endcapture %}
