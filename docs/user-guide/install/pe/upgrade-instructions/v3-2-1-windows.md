...
description: ThingsBoard PE upgrade guide for Windows - v3.2.1
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.2PE. In order to upgrade to 3.2.1PE you need to [**upgrade to 3.2PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.2-windows/).
