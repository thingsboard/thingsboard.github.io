...
title: Upgrade to v3.3.2 (Centos)
description: ThingsBoard PE upgrade guide for Centos - v3.3.2
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.3.1PE. In order to upgrade to 3.3.2PE you need to [**upgrade to 3.3.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.3.1-centos/).

#### ThingsBoard PE package download

```bash
{% include_relative resources/3.3.2pe/thingsboard-centos-download.sh %}
```
{: .copy-code}
...
```bash
{% include_relative resources/3.3.2pe/thingsboard-centos-installation.sh %}
```
{: .copy-code}
