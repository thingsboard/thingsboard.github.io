...
{% include code.html file="resources/3.3.4pe/thingsboard-centos-download.sh" language="shell" %}
...
{% include code.html file="resources/3.3.4pe/thingsboard-centos-installation.sh" language="shell" %}
