...
title: Upgrade to v3.2.2 (Ubuntu)
description: ThingsBoard PE upgrade guide for Ubuntu - v3.2.2
hidetoc: "true"
breadcrumbs: "true"
breadcrumbs-steps: "1"
---
...
**NOTE**: These upgrade steps are applicable for ThingsBoard version 3.2.1PE. In order to upgrade to 3.2.2PE you need to [**upgrade to 3.2.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.2.1-ubuntu/).
