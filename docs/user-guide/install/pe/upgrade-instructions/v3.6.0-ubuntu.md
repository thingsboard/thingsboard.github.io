...
{% include code.html file="resources/3.6pe/thingsboard-ubuntu-download.sh" language="shell" %}
...
{% include code.html file="resources/3.6pe/thingsboard-ubuntu-installation.sh" language="shell" %}
