...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.4.1PE. In order to upgrade to 3.4.2PE you need to [**upgrade to 3.4.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/v3.4.1-centos/).
{% endcapture %}
...
```bash
{% include_relative resources/3.4.2pe/thingsboard-centos-download.sh %}
```
{: .copy-code}
...
```bash
{% include_relative resources/3.4.2pe/thingsboard-centos-installation.sh %}
```
{: .copy-code}
