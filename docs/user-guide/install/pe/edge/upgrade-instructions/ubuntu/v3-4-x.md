...
title: ThingsBoard Edge PE v3.4.x upgrade instructions for Ubuntu
description: ThingsBoard Edge PE v3.4.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-4-x/#upgrading-thingsboard-pe-to-343" %}
...
{% assign updateServerLink = "ubuntu/v3-4-x/#upgrading-thingsboard-pe-to-341" %}
...
{% assign updateServerLink = "ubuntu/v3-4-x/#upgrading-thingsboard-pe-to-34" %}
