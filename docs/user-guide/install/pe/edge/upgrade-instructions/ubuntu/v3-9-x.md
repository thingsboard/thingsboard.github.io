...
title: ThingsBoard Edge PE v3.9.x upgrade instructions for Ubuntu
description: ThingsBoard Edge PE v3.9.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-9-x/#upgrading-thingsboard-pe-to-391" %}
...
{% assign updateServerLink = "ubuntu/v3-9-x/#upgrading-thingsboard-pe-to-390" %}
