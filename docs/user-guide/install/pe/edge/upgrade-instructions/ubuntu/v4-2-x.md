...
{% assign updateServerLink = "ubuntu/v4-2-x/#upgrading-thingsboard-pe-to-4211" %}
...
```bash
wget https://dist.thingsboard.io/tb-edge-4.2.1.1pe.deb
```
{: .copy-code}
...
```bash
sudo dpkg -i tb-edge-4.2.1.1pe.deb
```
{: .copy-code}
...
{% assign updateServerLink = "ubuntu/v4-2-x/#upgrading-thingsboard-pe-to-421" %}
...
```bash
wget https://dist.thingsboard.io/tb-edge-4.2.1pe.deb
```
{: .copy-code}
...
```bash
sudo dpkg -i tb-edge-4.2.1pe.deb
```
{: .copy-code}
