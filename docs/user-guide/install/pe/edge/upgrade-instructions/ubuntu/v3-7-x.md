...
title: ThingsBoard Edge PE v3.7.x upgrade instructions for Ubuntu
description: ThingsBoard Edge PE v3.7.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-7-x/#upgrading-thingsboard-pe-to-37" %}
