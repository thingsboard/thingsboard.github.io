...
title: ThingsBoard Edge PE v3.3.x upgrade instructions for Ubuntu
description: ThingsBoard Edge PE v3.3.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-3-x/#upgrading-thingsboard-pe-to-3341" %}
