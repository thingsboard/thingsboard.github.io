...
title: ThingsBoard Edge PE v3.5.x upgrade instructions for Ubuntu
description: ThingsBoard Edge PE v3.5.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-5-x/#upgrading-thingsboard-pe-to-351" %}
...
{% assign updateServerLink = "ubuntu/v3-5-x/#upgrading-thingsboard-pe-to-35" %}
