...
title: ThingsBoard Edge PE v3.9.x upgrade instructions for CentOS
description: ThingsBoard Edge PE v3.9.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v3-9-x/#upgrading-thingsboard-pe-to-391" %}
...
{% assign updateServerLink = "centos/v3-9-x/#upgrading-thingsboard-pe-to-390" %}
