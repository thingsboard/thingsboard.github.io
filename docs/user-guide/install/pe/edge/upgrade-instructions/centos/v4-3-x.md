...
## Upgrading Edge PE to 4.3

{% assign updateServerLink = "centos/v4-3-x/#upgrading-thingsboard-pe-to-430" %}
...
```bash
wget https://dist.thingsboard.io/tb-edge-4.3pe.rpm
```
{: .copy-code}
...
```bash
sudo rpm -Uvh tb-edge-4.3pe.rpm
```
{: .copy-code}
