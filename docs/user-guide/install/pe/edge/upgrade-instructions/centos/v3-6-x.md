...
title: ThingsBoard Edge PE v3.6.x upgrade instructions for CentOS
description: ThingsBoard Edge PE v3.6.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v3-6-x/#upgrading-thingsboard-pe-to-364" %}
...
{% assign updateServerLink = "centos/v3-6-x/#upgrading-thingsboard-pe-to-363" %}
...
{% assign updateServerLink = "centos/v3-6-x/#upgrading-thingsboard-pe-to-362" %}
...
{% assign updateServerLink = "centos/v3-6-x/#upgrading-thingsboard-pe-to-361" %}
...
{% assign updateServerLink = "centos/v3-6-x/#upgrading-thingsboard-pe-to-36" %}
