...
title: ThingsBoard Edge PE v4.0.x upgrade instructions for CentOS
description: ThingsBoard Edge PE v4.0.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v4-0-x/#upgrading-thingsboard-pe-to-401" %}
