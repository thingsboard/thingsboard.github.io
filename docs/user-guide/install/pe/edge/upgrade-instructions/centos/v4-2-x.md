...
title: ThingsBoard Edge PE v4.2.x upgrade instructions for CentOS
...
{% assign updateServerLink = "centos/v4-2-x/#upgrading-thingsboard-pe-to-4221" %}
...
{% assign updateServerLink = "centos/v4-2-x/#upgrading-thingsboard-pe-to-422" %}
...
```bash
wget https://dist.thingsboard.io/tb-edge-4.2.2pe.rpm
```
{: .copy-code}
...
{% assign updateServerLink = "centos/v4-2-x/#upgrading-thingsboard-pe-to-421-4212" %}
...
{% assign updateServerLink = "centos/v4-2-x/#upgrading-thingsboard-pe-to-42" %}
