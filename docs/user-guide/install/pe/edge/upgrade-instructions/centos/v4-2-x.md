...
{% assign updateServerLink = "centos/v4-2-x/#upgrading-thingsboard-pe-to-4211" %}
...
```bash
wget https://dist.thingsboard.io/tb-edge-4.2.1.1pe.rpm
```
{: .copy-code}
...
```bash
sudo rpm -Uvh tb-edge-4.2.1.1pe.rpm
```
{: .copy-code}
...
{% assign updateServerLink = "centos/v4-2-x/#upgrading-thingsboard-pe-to-421" %}
...
```bash
wget https://dist.thingsboard.io/tb-edge-4.2.1pe.rpm
```
{: .copy-code}
...
```bash
sudo rpm -Uvh tb-edge-4.2.1pe.rpm
```
{: .copy-code}
...
{% assign updateServerLink = "centos/v4-2-x/#upgrading-thingsboard-pe-to-420" %}
