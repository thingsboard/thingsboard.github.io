...
title: ThingsBoard Edge PE v3.5.x upgrade instructions for CentOS
description: ThingsBoard Edge PE v3.5.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v3-5-x/#upgrading-thingsboard-pe-to-3511" %}
...
{% assign updateServerLink = "centos/v3-5-x/#upgrading-thingsboard-pe-to-351" %}
...
{% assign updateServerLink = "centos/v3-5-x/#upgrading-thingsboard-pe-to-35" %}
