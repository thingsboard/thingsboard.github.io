...
title: ThingsBoard Edge PE v3.3.x upgrade instructions for Docker
description: ThingsBoard Edge PE v3.3.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-3-x/#upgrading-thingsboard-pe-to-3341" %}
