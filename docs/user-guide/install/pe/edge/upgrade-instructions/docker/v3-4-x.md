...
title: ThingsBoard Edge PE v3.4.x upgrade instructions for Docker
description: ThingsBoard Edge PE v3.4.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-4-x/#upgrading-thingsboard-pe-to-343" %}
...
{% assign updateServerLink = "docker/v3-4-x/#upgrading-thingsboard-pe-to-341" %}
{% assign peDocsPrefix = "pe/" %}
{% include templates/edge/install/compatibility-warning-version.md %}
{% capture edge-previousVersion %}
These steps are applicable for Edge {{previousVersion}} version.
...
{% assign updateServerLink = "docker/v3-4-x/#upgrading-thingsboard-pe-to-34" %}
{% assign peDocsPrefix = "pe/" %}
{% include templates/edge/install/compatibility-warning-version.md %}
