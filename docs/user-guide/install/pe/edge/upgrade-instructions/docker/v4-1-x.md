...
title: ThingsBoard Edge PE v4.1.x upgrade instructions for Docker
description: ThingsBoard Edge PE v4.1.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v4-1-x/#upgrading-thingsboard-pe-to-410" %}
