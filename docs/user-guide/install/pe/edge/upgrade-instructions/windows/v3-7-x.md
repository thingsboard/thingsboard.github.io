...
title: ThingsBoard Edge PE v3.7.x upgrade instructions for Windows
description: ThingsBoard Edge PE v3.7.x upgrade guide for Windows
...
{% assign updateServerLink = "windows/v3-7-x/#upgrading-thingsboard-pe-to-370" %}
