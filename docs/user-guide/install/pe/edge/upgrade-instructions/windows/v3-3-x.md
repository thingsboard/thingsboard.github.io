...
title: ThingsBoard Edge PE v3.3.x upgrade instructions for Windows
description: ThingsBoard Edge PE v3.3.x upgrade guide for Windows
...
{% assign updateServerLink = "windows/v3-3-x/#upgrading-thingsboard-pe-to-3341" %}
