...
title: ThingsBoard Edge PE v3.4.x upgrade instructions for Windows
description: ThingsBoard Edge PE v3.4.x upgrade guide for Windows
...
{% assign updateServerLink = "windows/v3-4-x/#upgrading-thingsboard-pe-to-343" %}
...
{% assign updateServerLink = "windows/v3-4-x/#upgrading-thingsboard-pe-to-341" %}
...
{% assign updateServerLink = "windows/v3-4-x/#upgrading-thingsboard-pe-to-340" %}
