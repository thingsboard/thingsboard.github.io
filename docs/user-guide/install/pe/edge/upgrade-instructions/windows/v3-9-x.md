...
title: ThingsBoard Edge PE v3.9.x upgrade instructions for Windows
description: ThingsBoard Edge PE v3.9.x upgrade guide for Windows
...
{% assign updateServerLink = "windows/v3-9-x/#upgrading-thingsboard-pe-to-391" %}
...
{% assign updateServerLink = "windows/v3-9-x/#upgrading-thingsboard-pe-to-390" %}
