...
docker pull store/thingsboard/tb-pe-web-ui:3.1PE
docker pull store/thingsboard/tb-pe-web-report:3.1PE
docker pull store/thingsboard/tb-pe-js-executor:3.1PE
docker pull store/thingsboard/tb-pe-http-transport:3.1PE
docker pull store/thingsboard/tb-pe-mqtt-transport:3.1PE
docker pull store/thingsboard/tb-pe-coap-transport:3.1PE
```
