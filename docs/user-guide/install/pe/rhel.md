...
```bash
wget https://dist.thingsboard.io/thingsboard-2.4.2pe.rpm
```
{: .copy-code}
...
```bash
sudo rpm -Uvh thingsboard-2.4.2pe.rpm
```
{: .copy-code}
...
```bash
wget https://dist.thingsboard.io/tb-web-report-2.4.2pe.rpm
```
{: .copy-code}
...
```bash
sudo rpm -Uvh tb-web-report-2.4.2pe.rpm
