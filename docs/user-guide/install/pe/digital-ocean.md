...
Please use the [official guide](https://www.digitalocean.com/docs/droplets/how-to/connect-with-ssh/) 
...
Please navigate to the [installation instruction](/docs/user-guide/install/pe/ubuntu/) 
for Ubuntu that is the same for all Ubuntu installations and complete install and post-install steps.

**Note:** Use your droplet IP address instead of "localhost" to access the instance.    
