...
In case if you are using the ThingsBoard 3.0+ version, the next link refers to those [Widget Development ThingsBoard 3.0+ version](/docs/user-guide/contribution/widgets-development/).
