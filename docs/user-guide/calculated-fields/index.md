...
calculated-field-output:
    0:
        image: https://img.thingsboard.io/user-guide/calculated-fields/script/output-1-ce.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/calculated-fields/script/output-2-ce.png
...
calculated-field-review-debug-2:
    0:
        image: https://img.thingsboard.io/user-guide/calculated-fields/calculated-field-review-debug-events-3-ce.png
        title: 'Click the <b>Events</b> icon in the calculated field row to view recorded debug events.'
    1:
        image: https://img.thingsboard.io/user-guide/calculated-fields/calculated-field-review-debug-events-4-ce.png
...
example-script-calculated-fields-1:
    0:
        image: https://img.thingsboard.io/user-guide/calculated-fields/example-script-function-1-ce.png
...
example-script-calculated-fields-2:
    0:
        image: https://img.thingsboard.io/user-guide/calculated-fields/example-2-script-function-1-ce.png
...
example-script-calculated-fields-3:
    0:
        image: https://img.thingsboard.io/user-guide/calculated-fields/example-3-script-function-1-ce.png
