...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/mainDashboard.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/Lora1.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/Lora2.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/converter.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/Integration.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/Verifying.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/verifying2.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/asset1.PNG)

![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/asset2.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/alarms1.PNG)

Then configure Root Rule chain. You should add in Root Rule chain Alarms wMBus Reader as it shown on the figure.

![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/alarms2.PNG)
...
![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/dash1.PNG)

When importing a dashboard, it will be necessary to create an alias, as shown in the figure.

![image](https://img.thingsboard.io/samples/smartico/wm-bus-lorawan/dash2.PNG)
