...
##### Step 1.1 Add a gateway
 ...
 After a gateway was created at Network Server and connected to the Internet, its status should be changed to *Online*.  
...
##### Step 1.2 Add a sensor
 ...
 - Create a new device in the application.  
  Smart Room Sensor has a sticker with QR code with a data required by Network Server.  
 ...
 After the sensor is provisioned, it necessary to turn it on to get LoRa packets in Network Server.  
 ...
 And, later on, uplink and downlink too.  
