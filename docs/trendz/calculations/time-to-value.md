...
calc-time-to-value-chart:
  0:
    image: https://img.thingsboard.io/trendz/calculations/calc-time-to-value-1.png

calc-time-to-value-script:
  0:
    image: https://img.thingsboard.io/trendz/calculations/calc-time-to-value-2.png

calc-time-to-value-output:
  0: 
    image: https://img.thingsboard.io/trendz/calculations/calc-time-to-value-3.png

calc-time-to-value-job:
  0:
    image: https://img.thingsboard.io/trendz/calculations/calc-time-to-value-4.png

calc-time-to-value-table:
  0:
    image: https://img.thingsboard.io/trendz/calculations/calc-time-to-value-5.png

calc-time-to-value-alarm:
  0:
    image: https://img.thingsboard.io/trendz/calculations/calc-time-to-value-6.png
  1:
    image: https://img.thingsboard.io/trendz/calculations/calc-time-to-value-7.png
---
