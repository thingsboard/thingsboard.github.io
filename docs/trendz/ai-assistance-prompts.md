...
trendz-prompts-test:
  0:
    image: https://img.thingsboard.io/trendz/ai/prompts/test-selected-prompt-1.png
    text: Click the *Run test* button in the upper-right corner of the prompt editor.
  1:
    image: https://img.thingsboard.io/trendz/ai/prompts/test-selected-prompt-2.png
  ...
  2:
    image: https://img.thingsboard.io/trendz/ai/prompts/test-selected-prompt-3.png
    text: Click the *Test prompt* button to generate the summary.
  3:
    image: https://img.thingsboard.io/trendz/ai/prompts/test-selected-prompt-4.png
    text: See the result.
---
