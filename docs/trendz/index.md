...
<div class="doc-features row mt-4">
    <div class="col-12 col-sm-6 col-lg col-xxl-6 col-4xl mb-4">
        <a class="feature-card" href="/docs/trendz/metric/overview/">
            <img class="feature-logo" src="https://img.thingsboard.io/trendz/icons/metric-explorer.svg" alt="metric-explorer">
    ...
    <div class="col-12 col-sm-6 col-lg col-xxl-6 col-4xl mb-4">
        <a class="feature-card" href="/docs/trendz/visualizations-overview/">
            <img class="feature-logo" src="https://img.thingsboard.io/trendz/icons/views.svg" alt="views">
