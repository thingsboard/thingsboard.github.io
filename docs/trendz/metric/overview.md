...
section-overview:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/section-overview-1.png
    title: '<b>Header</b> - Entity, Item, and Timerange selection.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/section-overview-2.png
    title: '<b>Fields Section</b> - Telemetries and attributes grouped by category.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/section-overview-3.png
    title: '<b>Tabs Section</b> - Data analysis and visualization tools.'

header-overview:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/header-overview-1.png
    title: 'Select an <b>Entity</b> (Device or Asset profile).'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/header-overview-2.png
    title: 'Select an <b>Item</b> (Device or Asset) you want to explore.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/header-overview-3.png
    title: 'Specify the <b>timerange</b> for the analysis.'
  3:
    image: https://img.thingsboard.io/trendz/metric/overview/header-overview-4.png
    title: 'Choose a metric (telemetry or attribute) for analysis.'

fields-overview:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/fields-overview-1.png
  ...
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/fields-overview-2.png
    title: '<b>Attribute</b> - Attributes from ThingsBoard.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/fields-overview-3.png
    title: '<b>Calculation</b> - Calculations saved by Trendz Calculation Fields to ThingsBoard.'
  3:
    image: https://img.thingsboard.io/trendz/metric/overview/fields-overview-4.png
    title: '<b>Generated Metrics</b> - Metrics created by the Metric Explorer.'
  4:
    image: https://img.thingsboard.io/trendz/metric/overview/fields-overview-5.png
    title: '<b>Prediction</b> - Predictions generated by Trendz Prediction Models and saved to ThingsBoard.'
  5:
    image: https://img.thingsboard.io/trendz/metric/overview/fields-overview-6.png
    title: '<b>Telemetry</b> - Raw telemetries from ThingsBoard.'

inactive-telemetries:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/inactive-telemetries-1.png
  ...
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/inactive-telemetries-2.png
    title: 'If a telemetry you are interested in is missing, click the <b>Show Inactive Telemetries</b> button to display telemetries that exist for the item but have no data in the selected timerange.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/topology-discovery.png
    title: 'If it still does not appear, perform a <b>refresh topology</b> to sync the latest ThingsBoard structure with Trendz.'

new-metric-button:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/new-metric-button.png
    title: 'You can also use the <b>+ New Metric</b> button to create new metrics from existing ones.'

fields-attributes:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/examples-attributes.png
    title: 'Clicking an attribute displays its value.'

telemetry-tabs:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/telemetry-tabs-1.png
    title: '<b>Overview</b> - Line chart or table view of telemetry values.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/telemetry-tabs-2.png
    title: '<b>Statistics</b> - Basic statistical summary for the selected timerange.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/telemetry-tabs-3.png
    title: '<b>Time Patterns</b> - Behavioral patterns across time units.'
  3:
    image: https://img.thingsboard.io/trendz/metric/overview/telemetry-tabs-4.png
    title: '<b>Range Analysis</b> - Distribution of telemetry values over time and range intervals.'
    
go-to-entity:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/go-to-entity-1.png
    title: '<b>Go to Entity</b> button for quick navigation to the related Trendz entity.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/go-to-entity-2.png
    title: '<b>Go to Entity</b> button for quick navigation to the related Trendz entity.'

fields-generated-metrics:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/examples-generated-metrics.png
    title: 'Displays metrics generated directly within the Metric Explorer.'

autoscale:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/autoscale-1.png
    title: 'When autoscale is disabled, the chart’s Y-axis range starts at 0 and ends at the maximum value.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/autoscale-2.png
...
tabs-overview-charts:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-overview-charts-1.png
    title: 'Switch between <b>Table</b> and <b>Line Chart</b> views.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-overview-charts-2.png
    title: 'Switch between <b>Table</b> and <b>Line Chart</b> views.'

tabs-overview-aggregation:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-overview-aggregation-1.png
    title: 'Configure grouping units'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-overview-aggregation-2.png
...
tabs-time-patterns:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-time-patterns-1.png
    title: '<b>Hour of Day Distribution</b> - Aggregation by hour of day.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-time-patterns-2.png
    title: '<b>Day of Week Distribution</b> - Aggregation by day of week.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-time-patterns-3.png
    title: '<b>Weekly Heatmap</b> - Aggregation by hour and weekday.'
  3:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-time-patterns-4.png
    title: '<b>Calendar Heatmap</b> - Aggregation by calendar days.'
  
tabs-range-default-actions:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-default-actions-1.png
    title: 'Configure ranges with colors.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-default-actions-2.png
    title: 'Remove ranges.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-default-actions-3.png
    title: 'Add ranges.'
  3:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-default-actions-4.png
    title: 'Reset to default (three automatically calculated ranges).'

tabs-range-views:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-views-1.png
    title: 'After configuration, click <b>Rebuild</b> to build views.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-views-2.png
    title: '<b>Summary Cards</b> - Total duration or percentage.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-views-3.png
    title: '<b>Charts</b> - Duration or percentage grouped by time.'
  3:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-views-4.png
    title: '<b>Range Summary</b> - Most frequent range and analysis period.'

tabs-range-customization:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-customization-1.png
    title: '<b>Value Aggregation</b> - Duration or duration percent.'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-customization-2.png
    title: '<b>Time Aggregation</b> - Select time unit.'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-customization-3.png
    title: '<b>Chart Type</b> - Line Chart.'
  3:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-customization-4.png
    title: '<b>Chart Type</b> - Stacked Bar.'

tabs-range-save-view:
  0:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-save-view-1.png
    title: 'Click <b>Save View</b>'
  1:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-save-view-2.png
    title: 'Click <b>Save</b>'
  2:
    image: https://img.thingsboard.io/trendz/metric/overview/tabs-range-save-view-3.png
...
You can access the Metric Explorer by clicking the ![image](https://img.thingsboard.io/trendz/metric/overview/chart-icon-without-preview.svg) icon.
