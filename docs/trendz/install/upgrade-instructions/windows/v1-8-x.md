...
title: Trendz Analytics v1.8.x upgrade instructions for Windows
description: Trendz Analytics v1.8.x upgrade guide for Windows
...
Download Trendz Analytics installation package for Windows: [trendz-windows-1.8.2.zip](https://dist.thingsboard.io/trendz-windows-1.8.2.zip).
...
Download Trendz Analytics installation package for Windows: [trendz-windows-1.8.1.zip](https://dist.thingsboard.io/trendz-windows-1.8.1.zip).
