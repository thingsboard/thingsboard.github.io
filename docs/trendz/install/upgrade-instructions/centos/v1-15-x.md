...
title: Trendz Analytics v1.15.x upgrade instructions for CentOS
description: Trendz Analytics v1.15.x upgrade guide for CentOS
...
{% include resources.liquid version="1.15.0" kind="centos-download" trendz="true" %}

#### Trendz Analytics service upgrade

* Install latest Trendz Analytics service

{% include resources.liquid version="1.15.0" kind="centos-installation" trendz="true" %}
