...
title: Trendz Analytics v1.9.x upgrade instructions for CentOS
description: Trendz Analytics v1.9.x upgrade guide for CentOS
...
{% include resources.liquid version="1.9.2-HF" kind="centos-download" trendz="true" %}

#### Trendz Analytics service upgrade

* Install Trendz Analytics service

{% include resources.liquid version="1.9.2-HF" kind="centos-installation" trendz="true" %}
