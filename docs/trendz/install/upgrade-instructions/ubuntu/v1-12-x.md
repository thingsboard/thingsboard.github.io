...
title: Trendz Analytics v1.12.x upgrade instructions for Ubuntu
description: Trendz Analytics v1.12.x upgrade guide for Ubuntu
...
{% include resources.liquid version="1.12.0" kind="ubuntu-download" trendz="true" %}  

#### Trendz Analytics service upgrade

* Install Trendz Analytics service 

{% include resources.liquid version="1.12.0" kind="ubuntu-installation" trendz="true" %} 
