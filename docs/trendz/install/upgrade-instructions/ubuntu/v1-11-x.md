...
title: Trendz Analytics v1.11.x upgrade instructions for Ubuntu
description: Trendz Analytics v1.11.x upgrade guide for Ubuntu
...
{% include resources.liquid version="1.11.2" kind="ubuntu-download" trendz="true" %}  

#### Trendz Analytics service upgrade

* Install Trendz Analytics service 

{% include resources.liquid version="1.11.2" kind="ubuntu-installation" trendz="true" %} 
...
{% include resources.liquid version="1.11.1" kind="ubuntu-download" trendz="true" %}  

#### Trendz Analytics service upgrade

* Install Trendz Analytics service 

{% include resources.liquid version="1.11.1" kind="ubuntu-installation" trendz="true" %} 
...
{% include resources.liquid version="1.11.0" kind="ubuntu-download" trendz="true" %}

#### Trendz Analytics service upgrade

* Install latest Trendz Analytics service 

{% include resources.liquid version="1.11.0" kind="ubuntu-installation" trendz="true" %} 
