...
<ul id="markdown-toc">
        <li>
          <a href="#upgrading-to-1151" id="markdown-toc-upgrading-to-1151">Upgrading to 1.15.1</a>
          <ul>
              <li>
                  <a href="#ubuntucentos-1151" id="markdown-toc-ubuntucentos-1151">Ubuntu/CentOS</a>        
              </li>
              <li>
                  <a href="#windows-1151" id="markdown-toc-windows-1151">Windows</a>        
              </li>
          </ul>
        </li>
        <li>
...
These steps are applicable for 1.15.0 Trendz Analytics version.

### Ubuntu/CentOS {#ubuntucentos-1151}

#### Trendz Analytics package download

{% capture tabspec %}trendz-download-1-15-1
trendz-download-1-15-1-ubuntu,Ubuntu,shell,resources/1.15.1/trendz-ubuntu-download.sh,/docs/user-guide/install/resources/1.15.1/trendz-ubuntu-download.sh
trendz-download-1-15-1-centos,CentOS,shell,resources/1.15.1/trendz-centos-download.sh,/docs/user-guide/install/resources/1.15.1/trendz-centos-download.sh{% endcapture %}  
{% include tabs.html %}
...
{% capture tabspec %}trendz-installation-1-15-1
trendz-installation-1-15-1-ubuntu,Ubuntu,shell,resources/1.15.1/trendz-ubuntu-installation.sh,/docs/user-guide/install/resources/1.15.1/trendz-ubuntu-installation.sh
trendz-installation-1-15-1-centos,CentOS,shell,resources/1.15.1/trendz-centos-installation.sh,/docs/user-guide/install/resources/1.15.1/trendz-centos-installation.sh{% endcapture %}  
{% include tabs.html %}
...
### Windows {#windows-1151}

#### Trendz Analytics package download

Download ThingsBoard Trendz Analytics installation package for Windows: [trendz-windows-1.15.1.zip](https://dist.thingsboard.io/trendz-windows-1.15.1.zip).
