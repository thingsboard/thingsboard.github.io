...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.4.4PE. In order to upgrade to 3.5PE you need to [**upgrade to 3.4.4PE first**](/docs/user-guide/install/pe/upgrade-instructions/windows/v3-4-x/#upgrading-thingsboard-pe-to-344).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
