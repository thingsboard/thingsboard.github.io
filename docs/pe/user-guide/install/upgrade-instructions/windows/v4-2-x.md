...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 4.1.xPE. In order to upgrade to 4.2PE you need to [**upgrade to 4.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/windows/v4-1-x/#upgrading-thingsboard-pe-to-410).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
