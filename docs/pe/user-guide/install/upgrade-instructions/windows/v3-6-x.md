...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.5.1PE. In order to upgrade to 3.6PE you need to [**upgrade to 3.5.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/windows/v3-5-x/#upgrading-thingsboard-pe-to-351).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
