...
title: ThingsBoard PE v3.4.x upgrade instructions for Docker Compose
description: ThingsBoard PE v3.4.x upgrade guide for Docker Compose
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.3.4.1PE. In order to upgrade to 3.4PE you need to [**upgrade to 3.3.4.1PE first**](/docs/pe/user-guide/install/upgrade-instructions/docker-compose/v3-3-x/#upgrading-thingsboard-pe-to-3341).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
