...
title: ThingsBoard PE v3.7.x upgrade instructions for Docker
description: ThingsBoard PE v3.7.x upgrade guide for Docker
...
```bash
docker pull thingsboard/tb-pe:3.7.0PE
```
{: .copy-code}
...
< . . . >
  mytbpe:
    image: "thingsboard/tb-pe:3.7.0PE"
< . . . >
```
{: .copy-code}
