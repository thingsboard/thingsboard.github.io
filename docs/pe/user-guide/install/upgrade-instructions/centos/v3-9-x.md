...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.8.1PE. In order to upgrade to 3.9PE you need to [**upgrade to 3.8.1PE first**](/docs/pe/user-guide/install/upgrade-instructions/centos/v3-8-x/#upgrading-thingsboard-pe-to-381).
<br>
[**Prepare**](#prepare-for-upgrading-thingsboard) for upgrading ThingsBoard.
{% endcapture %}
{% include templates/info-banner.md content=difference %}
