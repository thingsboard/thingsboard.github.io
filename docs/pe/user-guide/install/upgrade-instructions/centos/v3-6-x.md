...
title: ThingsBoard PE v3.6.x upgrade instructions for CentOS
description: ThingsBoard PE v3.6.x upgrade guide for CentOS
...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.5.1PE. In order to upgrade to 3.6PE you need to [**upgrade to 3.5.1PE first**](/docs/pe/user-guide/install/upgrade-instructions/centos/v3-5-x/#upgrading-thingsboard-pe-to-351).
<br>
[**Prepare**](#prepare-for-upgrading-thingsboard) for upgrading ThingsBoard.
{% endcapture %}
{% include templates/info-banner.md content=difference %}
