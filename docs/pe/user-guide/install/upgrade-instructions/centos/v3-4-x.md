...
**NOTE:**
<br>
These upgrade steps are applicable for ThingsBoard version 3.3.4.1PE. In order to upgrade to 3.4PE you need to [**upgrade to 3.3.4.1PE first**](/docs/pe/user-guide/install/upgrade-instructions/centos/v3-3-x/#upgrading-thingsboard-pe-to-3341).
<br>
[**Prepare**](#prepare-for-upgrading-thingsboard) for upgrading ThingsBoard.
{% endcapture %}
{% include templates/info-banner.md content=difference %}
