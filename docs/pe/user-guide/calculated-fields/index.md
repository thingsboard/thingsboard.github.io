...
calculated-field-output:
    0:
        image: https://img.thingsboard.io/user-guide/calculated-fields/script/script-output-1-pe.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/calculated-fields/script/script-output-2-pe.png
