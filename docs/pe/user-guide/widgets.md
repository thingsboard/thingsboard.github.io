...
data-source-type-random:
    ...
    2:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-random-3-pe.png
...
data-source-type-entities-сount:
    0:
        ...
        title: 'Open your dashboard and enter edit mode. Then click the "+ Add widget" icon at the top of the screen, or (if this is your first widget on this dashboard) click a large "Add new widget" sign in the middle of the screen to open the "Widgets bundle” dialog box;'
    1:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-entities-сount-2-pe.png
        title: 'Select a "Cards" widget bundle;'
    2:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-entities-сount-3-pe.png
        title: 'Then select a "Simple card" widget;'
    3:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-entities-сount-4-pe.png
    ...
    4:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-entities-сount-5-pe.png
        title: 'In the opened Add alias dialog, enter an alias name, select filter type - "Entity type", and choose an entity type - "Device". Click "Add";'
    5:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-entities-сount-6-pe.png
        title: 'In the Data key row click the "pencil" icon of the "count" key to open data key configuration window;'
    6:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-entities-сount-7-pe.png
        title: 'Change label name to "Device count" and specify units. Click "Save";'
    7:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-entities-сount-8-pe.png
        title: 'Finally, click "Add" and save all changes;'
    8:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-entities-сount-9-pe.png
...
data-source-type-alarms-сount:
    ...
    2:
        ...
        title: 'Then select a "Simple card" widget;'
    3:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-alarms-сount-4-pe.png
    ...
    4:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-alarms-сount-5-pe.png
        title: 'Change label name to "Alarms count" and specify units. Click "Save";'
    5:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-alarms-сount-6-pe.png
        title: 'Finally, click "Add" and apply changes;'
    6:
        image: /images/user-guide/widgets/overview/data-settings/data-source-type-alarms-сount-7-pe.png
