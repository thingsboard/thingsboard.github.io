...
data-source-type-device:
    0:
        ...
        title: 'Open your dashboard and enter edit mode. Then click the "+ Add widget" icon at the top of the screen, or (if this is your first widget on this dashboard) click a large "Add new widget" sign in the middle of the screen to open the "Widgets bundle” dialog box;'
    1:
        image: /images/user-guide/widgets/overview/data-source-type-device-2-pe.png
...
data-source-type-alarms-сount:
    ...
    6:
        image: /images/user-guide/widgets/overview/data-source-type-alarms-сount-7-pe.png
        title: 'Now we have a widget that displays all alarms of existing devices.'

add-data-key:
    0:
        image: /images/user-guide/widgets/overview/add-data-key-1-pe.png
...
add-key-in-the-future:
    0:
        image: /images/user-guide/widgets/overview/add-key-in-the-future-1-pe.png
...
default-data-settings:
    0:
        image: /images/user-guide/widgets/overview/default-data-settings-1-pe.png
