...
login-with-google-1:
    ...
    2:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/login-with-oauth-1-pe.png
        title: 'You are logged into ThingsBoard using your Google email as a Tenant Administrator.'

login-with-google-2:
    0:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/login-with-oauth-2-pe.png
...
login-with-oauth-customer:
    0:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/login-with-oauth-customer-2-pe.png
...
keycloak-add-thingsboard-oauth-client:
    0:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-thingsboard-1-pe.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-thingsboard-2-pe.png
    ...
    2:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-thingsboard-3-pe.png
    ...
    3:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-thingsboard-4-pe.png
        title: 'A new OAuth 2.0 client has been added.'

keycloak-add-domain:
    0:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/keycloak/keycloak-adding-domain-1-pe.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/oauth-2-support/keycloak/keycloak-adding-domain-2-pe.png
        title: 'A new domain has been added.'
