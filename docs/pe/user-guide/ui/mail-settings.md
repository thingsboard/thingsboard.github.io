...
azure-portal:
    0:
        image: https://img.thingsboard.io/user-guide/ui/mail/microsoft-azure-with-oauth2-1-pe.png
        title: 'Sign in to the Azure portal and select Azure Active Directory;'
    1:
        image: https://img.thingsboard.io/user-guide/ui/mail/microsoft-azure-with-oauth2-2-pe.png
        title: 'Under "Manage" select "App registrations" then click "New registration";'
    2:
        image: https://img.thingsboard.io/user-guide/ui/mail/microsoft-azure-with-oauth2-3-pe.png
