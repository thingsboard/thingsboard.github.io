...
basic-datakey:
    0:
        image: /images/user-guide/dashboards/datakey-pe.png
        title: 'Click the pencil icon next to the datakey name to open the Datakey configuration window.'
    1:
        image: /images/user-guide/dashboards/datakey-1-pe.png
