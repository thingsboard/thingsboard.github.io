...
step2:
    ...
    4:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-2-item-5.png
...
step32:
    0:
        ...
        title: 'Click on the device row in the table to open device details.'
    1:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-3-item-3.png
...
step51:
    0:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-51-item-1.png
    ...
    1:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-51-item-2.png
        title: 'Input dashboard group name. For example, "Edge dashboards". Click "Add" to add the dashboard group.'
    2:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-51-item-3.png
        title: 'Click on the "Open" icon to open new dashboard group.'
    2:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-51-item-4.png
        title: 'Click on the "+" icon to create new dashboard.'
    3:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-51-item-5.png
        title: 'Input dashboard name. For example, "My New Dashboard". Click "Add" to add the dashboard.'
    4:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-51-item-6.png
...
step52:
    0:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-52-item-1.png
        title: 'Enter edit mode. Click on the pencil button in the bottom right corner.'
    1:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-52-item-2.png
        title: 'Click "Entity Aliases" icon in the top right part of the screen. You will see empty list of Entity aliases.'
    2:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-52-item-3.png
        title: 'Click "Add alias".'
    3:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-52-item-4.png
    ...
    4:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-52-item-5.png
        title: 'Click "Add" and then "Save".'        
    5:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-52-item-6.png
        title: 'Finally, Click "Apply changes" in the dashboard editor to save the changes. Then you should enter edit mode again.'

step53:
    0:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-53-item-1.png
        title: 'Enter edit mode. Click on the "Add new widget" button.'
    1:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-53-item-2.png
    ...
    2:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-53-item-3.png
        title: 'Click "Add" to add the data source. Widget may have multiple data sources, but we will use only one in this case.'
    3:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-53-item-4.png
    ...
    4:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-53-item-5.png
...
step54:
    0:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-1.png
        title: 'Enter Edit mode.'
    1:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-2.png
        title: 'Click "Add new widget" icon in the bottom right corner of the screen.'
    2:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-3.png
        title: 'Click "Create new widget" icon.'
    3:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-4.png
        title: 'Select "Charts" bundle. Scroll down and click on the "Timeseries - Flot" chart widget.'        
    4:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-5.png
        title: 'Click "Add datasource" button.'
    5:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-6.png
        title: 'Select "MyDevice" Alias. Select "temperature" key. Click "Add".'
    6:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-7.png
        title: 'Drag and Drop you widget to desired space. Resize the widget.'
    7:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-8.png
    ...
    8:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-54-item-9.png
...
step6PE:
    0:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-6-item-1.png
        title: 'Open "Edge groups" page in the ThingsBoard <b>Professional Edition</b> server and open "All" group.'
    1:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-6-item-2.png
    ...
    2:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-6-item-3.png
        title: 'Click on the "+" icon to assign dashboard groups.'
    3:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-6-item-4.png
...
step6Edge:
    0:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-6-item-5-edge.png
    ...
    1:
        image: https://img.thingsboard.io/pe/edge/getting-started/step-6-item-6-edge.png
        title: 'Verify that you see the same widgets that you have added on the cloud and temperature readings from the device.'

mqttWindows:
    0:
        image: https://img.thingsboard.io/pe/edge/getting-started/mqtt-windows-item-1.png
        title: 'Create new MQTT Client with the properties listed in screenshots below.'
    1:
        image: https://img.thingsboard.io/pe/edge/getting-started/mqtt-windows-item-2.png
