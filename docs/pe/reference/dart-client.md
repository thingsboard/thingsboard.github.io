...
providing model objects and services to communicate with ThingsBoard PE platform using [RESTful APIs](/docs/pe/reference/rest-api/) and WebSocket protocol.
With Dart Client you can programmatically access ThingsBoard PE API to manage [entities](/docs/pe/user-guide/entities-and-relations/),
