...
mosquitto_pub -d -h "127.0.0.1" -t "v1/devices/me/attributes" -u "ABC123" -m "{"attribute1": "value1", "attribute2": true}"
...
# For example, $THINGSBOARD_HOST_NAME reference your local installation, $ACCESS_TOKEN is ABC123:
mosquitto_pub -d -h "127.0.0.1" -t "v1/devices/me/attributes" -u "ABC123" -f "new-attributes-values.json"