...
cat telemetry-data-as-object.json | coap post coap://127.0.0.1/api/v1/ABC123/telemetry
...
# For example, $THINGSBOARD_HOST_NAME reference your local installation, $ACCESS_TOKEN is ABC123:
cat telemetry-data-as-array.json | coap post coap://127.0.0.1/api/v1/ABC123/telemetry
...
# For example, $THINGSBOARD_HOST_NAME reference your local installation, $ACCESS_TOKEN is ABC123:
cat telemetry-data-with-ts.json | coap post coap://127.0.0.1/api/v1/ABC123/telemetry