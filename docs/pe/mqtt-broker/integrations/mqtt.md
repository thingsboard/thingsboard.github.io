...
add-mqtt-integration:
  ...
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/add-mqtt-integration-2.png
    title: 'Select "MQTT" as the integration type and click "Next".'
  2:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/add-mqtt-integration-3.png
    title: 'Change default topic filter to "tbmq/mqtt-integration" and click "Next".'
  3:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/add-mqtt-integration-4.png
...
send-uplink-message:
  ...
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/send-mqtt-message-2.png
