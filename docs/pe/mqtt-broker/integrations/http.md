...
add-http-integration:
  ...
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/add-http-integration-2.png
  ...
  3:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/add-http-integration-4.png
    title: 'In the field "Endpoint URL" paste the URL from the HTTP integration of your ThingsBoard Cloud.'
  4:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/add-http-integration-5.png
...
send-uplink-message:
  ...
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/send-uplink-message-2.png
