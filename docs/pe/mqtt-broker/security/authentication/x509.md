...
security-authentication-tls:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/features/security-authentication-tls-1.png
...
security-authorization-tls:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/features/security-authorization-tls-1.png
...
authentication-provider-control:
  ...
  2:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/x509/x509-overview.png
