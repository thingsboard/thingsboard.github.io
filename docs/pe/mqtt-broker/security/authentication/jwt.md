...
configure-jwt-auth-provider:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-jwt-auth-provider.png
...
configure-signature-verifier-mechanism:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-signature-verifier-mechanism.png
...
configure-hmac-based-verifier-mechanism:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-hmac-based-verifier-mechanism.png
...
configure-pem-based-verifier-mechanism:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-pem-based-verifier-mechanism.png
...
configure-jwks-based-verifier-mechanism:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-jwks-based-verifier-mechanism-0.png
    title: 'Enter the JWKS endpoint URL, which TBMQ will use to fetch the JSON Web Key Set for token signature verification.'
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-jwks-based-verifier-mechanism-1.png
    title: 'Set the refresh interval in seconds. This controls how often TBMQ retrieves the JWKS from the remote endpoint.'
  2:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-jwks-based-verifier-mechanism-2.png
  ...
  3:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-jwks-based-verifier-mechanism-3.png
...
configure-auth-claims:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-auth-claims.png
...
configure-client-type:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-client-type.png
...
configure-jwt-authorization:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/configure-jwt-authorization.png
...
enable-and-save-jwt-provider:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/enable-and-save-jwt-provider.png
...
jwt-mqtt-example:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/jwt-mqtt-example.png
    title: ''
jwt-mqtts-example:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/jwt/jwt-mqtts-example.png
    title: ''
---
