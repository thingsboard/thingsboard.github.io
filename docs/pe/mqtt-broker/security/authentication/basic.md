...
security-authentication-basic:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/features/security-authentication-basic-1.png
    title: 'Copy Basic credentials ID.'
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/features/security-authentication-basic-2.png
    title: 'Basic authentication credentials params: Client ID, Username and Password.'

security-authorization-basic:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/features/security-authorization-basic-1.png
...
authentication-provider-control:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/provider-home-switch.png
    title: 'Go to the Broker Settings card on the Home page to switch authentication providers.'
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/provider-table-switch.png
  ...
  2:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/basic/basic-overview.png
...
tbmq-client-id-username-and-password:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/basic/auth-client-id-username-and-password.png
    title: ''
    
tbmq-tls-client-id-username-and-password:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/security/auth-providers/basic/tls-auth-client-id-username-and-password.png
    title: ''
