...
adding-domain-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/adding-domain-1.png
    ...
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/adding-domain-2.png
        title: 'Domain added.'
    
editing-domain-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/managing-domain-1.png
        title: 'Click on the domain to view its details. Switch to editing mode by clicking the large orange button;'
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/managing-domain-2.png
        title: 'Make the required modifications. Then confirm and save the changes by clicking the "Apply changes" button.'
    
deleting-domain-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/deleting-domain-1.png
        title: 'Click the "trash" icon in the domain&#39;s row you wish to remove;'
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/deleting-domain-2.png
        title: 'Confirm the deletion by clicking "Yes".'

adding-oauth2-client-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/adding-oauth2-client-1.png
        title: 'Navigate to the "OAuth 2.0 clients" tab on the "OAuth 2.0" page. Click the "plus" icon to add a new OAuth 2.0 client;'
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/adding-oauth2-client-2.png
    ...
    2:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/adding-oauth2-client-3.png
        title: 'New OAuth 2.0 client added.'

editing-oauth2-client-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/managing-oauth2-client-1.png
        title: 'Click on the OAuth 2.0 client to view its details. Switch to editing mode by clicking the large orange button;'
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/managing-oauth2-client-2.png
        title: 'Make the required modifications. Then confirm and save the changes by clicking the "Apply changes" button.'

deleting-oauth2-client-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/deleting-oauth2-client-1.png
        title: 'Click the "trash" icon in the client&#39;s row you wish to remove;'
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/deleting-oauth2-client-2.png
        title: 'Confirm the deletion by clicking "Yes".'

google-credentials-for-oauth-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-credentials-for-oauth-1.png
        title: 'Go to the "Credentials" page in the left menu and select "OAuth client ID" from the "Create credentials" dropdown menu;'
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-credentials-for-oauth-2.png
        title: 'Enter a OAuth client name, and add the TBMQ redirect URI, to the "Authorized Redirect URIs" section. Then, click "Create";'
    2:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-credentials-for-oauth-3.png
...
google-configuration-of-thingsboard-google-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-thingsboard-1.png
    ...
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-thingsboard-2.png
...
google-configuration-of-thingsboard-google-2:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-thingsboard-3.png
    ...
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-thingsboard-4.png
...
google-configuration-of-thingsboard-google-3:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-thingsboard-5.png
...
google-configuration-of-thingsboard-google-4:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-thingsboard-6.png
        title: 'The OAuth client is added successfully. Click "Add" again to confirm the addition of the domain;'
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-thingsboard-7.png
        title: 'A new domain has been added.'

login-with-google-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/login-with-google-1.png
...
login-with-google-2:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/login-oauth-user.png
        title: 'Go to the "Users" page. There you should find a new user that you have just logged in.'

auth0-credentials-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-credentials-1.png
    ...
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-credentials-2.png
        title: 'Name your application "TBMQ", and choose the application type - "Regular Web Applications";'
    2:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-credentials-3.png
        title: 'Afters, you need to choose the technology being used. Please, choose the "Java Spring Boot" technology;'
    3:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-credentials-4.png
    ...
    4:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-credentials-5.png
        title: 'As well, please update your allowed Callback URLs;'
    5:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-credentials-6.png
...
oauth0-configuration-of-thingsboard-2:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-configuration-of-thingsboard-3.png
...
oauth0-configuration-of-thingsboard-3:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-configuration-of-thingsboard-4.png
...
oauth0-configuration-of-thingsboard-4:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-configuration-of-thingsboard-5.png
        title: 'The OAuth0 client has been successfully added. Click "Add" again to confirm the addition of the domain.'
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-configuration-of-thingsboard-6.png
        title: 'A new domain has been added.'

login-with-oauth0-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/login-with-oauth0-1.png
...
keycloak-add-thingsboard-oauth-client-1:
    ...
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/keycloak-configuration-of-thingsboard-2.png
...
keycloak-add-thingsboard-oauth-client-2:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/keycloak-configuration-of-thingsboard-3.png
    ...
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/keycloak-configuration-of-thingsboard-4.png
        title: 'A new OAuth 2.0 client has been added.'

keycloak-add-domain:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/keycloak-adding-domain-1.png
    ...
    1:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/keycloak-adding-domain-2.png
        title: 'A new domain has been added.'

login-with-keycloak-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/login-with-keycloak-1.png
...
mapper-basic-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/mapper-basic-1.png
        title: 'To use a basic mapper, set mapper type "Basic".'

mapper-custom-1:
    0:
        image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/oauth-2-support/mapper-custom-1.png
