...
shared-subscription-group:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/shared-sub-group.png
    title: 'Shared Subscription group'

shared-subscription-groups:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/shared-sub-groups.png
