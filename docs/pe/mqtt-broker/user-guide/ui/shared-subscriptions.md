...
add-shared-subscriptions:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/add-shared-subscriptions-1.png
    title: 'Open Shared Subscriptions page and click on the "plus" icon.'
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/add-shared-subscriptions-2.png
    title: 'Fill in the Name, Topic filter and Partitions fields.'

delete-shared-subscriptions:
  0:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/delete-shared-subscriptions-1.png
    title: 'Delete single. Click on the icon "Delete".'
  1:
    image: https://img.thingsboard.io/pe/mqtt-broker/user-guide/ui/delete-shared-subscriptions-2.png
