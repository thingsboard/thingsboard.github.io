...
curl -v -X POST --data "{"temperature":42,"humidity":73}" {{httpsHostName}}/api/v1/ABC123/telemetry --header "Content-Type:application/json"
...
# For example, $ACCESS_TOKEN is ABC123:
curl -v -X POST -d @telemetry-data-as-object.json {{httpsHostName}}/api/v1/ABC123/telemetry --header "Content-Type:application/json"
...
# For example, $ACCESS_TOKEN is ABC123:
curl -v -X POST -d @telemetry-data-as-array.json {{httpsHostName}}/api/v1/ABC123/telemetry --header "Content-Type:application/json"
...
# For example, $ACCESS_TOKEN is ABC123:
curl -v -X POST -d @telemetry-data-with-ts.json {{httpsHostName}}/api/v1/ABC123/telemetry --header "Content-Type:application/json"