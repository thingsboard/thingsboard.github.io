...
adding-new-rule-chain-1:
    ...
    4:
        ...
        title: 'Name it "Indoor air quality emulator". Set "Message count" to 100 and "Period in second" to 60. Select the originator as "Device" and specify the device "SD-001" (Indoor Air Quality Sensor). Copy the script from the documentation and paste it into the generation function section to simulate telemetry data for temperature, humidity, and CO2. Click "Add".'
...
customize-office-sensors-list-widget-2:
    0:
        ...
        title: 'Now, the Office sensors list widget will display a list of your devices with their telemetry values combined into a single column for each device.'
...
adding-devices-states-1:
    ...
    2:
        ...
        title: 'Enter state&#39;s name. For the state to be named after the entity, use "<b>Indoor Air Quality Sensor</b>" as the name of the state. Enter state ID: "<b>smart_sensor</b>". Click "Add".'
...
action-go-to-device-1:
    0:
        ...
        title: 'Enter the editing mode of the Building sensors list widget;'
    1:
        image: /images/user-guide/advanced-guides-for-working-with-dashboard/lesson-3/go-to-device-state-2-pe.png
        title: 'Scroll down, find the "Actions" menu section and click the "Add action" button;'
    2:
    ...
    3:
        ...
        title: 'In the "Add action" dialog, select "On row click" action source, and enter any action name. Then, choose the "Custom action" action type. After choosing an action type, the "Custom action function" section appears. Paste the function provided in the documentation. After, click "Add";'
    4:
...
action-go-to-device-2:
    0:
        ...
        title: 'Click on the sensor row to transition to its state.'
    1:
...
customize-office-plan-widget-1:
    0:
        ...
        title: 'Go to the dashboard edit mode and click the "pencil" icon on the Office plan widget to enter its edit mode;'
    1:
        image: /images/user-guide/advanced-guides-for-working-with-dashboard/lesson-3/customize-office-plan-widget-2-pe.png
        title: 'Add data keys like "temperature", "humidity", "co2", "powerConsumption", "waterConsumption," and "batteryLevel". These are telemetry keys. The telemetry of the selected device will be displayed in a tooltip when you click on it;'
...
customize-office-plan-widget-2:
    0:
        ...
        title: 'Scroll down a bit more to find the "Tooltip" section. Enable the "Use tooltip function" option. Then, copy the tooltip function from the documentation and paste it into the "Tooltip function" field of the widget. Then, set the tooltip Y offset relative to the marker to -0.77;'
...
customize-office-plan-widget-5:
    0:
        ...
        title: 'Click on any marker to trigger a tooltip. In each device’s tooltip, there is a line to access the details of the selected device. Click on this line.'
    1:
...
indoor-air-quality-sensor-card-widgets-1:
    0:
        ...
        title: 'Click on the "Indoor Air Quality Sensor" device to go to its state;'
    1:
...
indoor-air-quality-sensor-card-widgets-2:
    ...
    4:
        ...
        title: 'The widget displaying the current humidity has been added. Adjust the its size.'
...
indoor-air-quality-sensor-card-widgets-3:
    ...
    4:
        ...
        title: 'The widget displaying the current CO2 level has been added. Adjust the widget size to match the dashboard aesthetics.'
