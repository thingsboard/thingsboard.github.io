...
high-temperature-alarm-rule-1:
    0:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-1-pe.png
...
high-temperature-alarm-rule-2:
    0:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-2-pe.png
...
high-temperature-alarm-rule-3:
    0:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-3-pe.png
        title: 'Add the argument (8) — the variable whose data will be used in the rule condition.'

high-temperature-alarm-rule-4:
    0:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-4-pe.png
        title: '<b>Add trigger condition</b> (10):<br> Set severity level to <b>Critical</b> (11), and click <b>Add condition</b> (12).'
    1:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-5-pe.png
        title: 'Click <b>Add argument filter</b> (13).'
    2:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-6-pe.png
    ...
    3:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-7-pe.png
        title: 'Click <b>Save</b> (18).'

high-temperature-alarm-rule-5:
    0:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-8-pe.png
        title: 'Click <b>Add trigger condition</b> (19).'
    1:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-9-pe.png
        title: 'Set <b>severity</b> level to <b>Major</b> (20), and click <b>Add condition</b> (21).'
    2:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-10-pe.png
        title: 'Click the <b>Add argument filter</b> (22).'
    3:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-11-pe.png
    ...
    4:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-12-pe.png
        title: 'Add another filter (26): <b>Operation (27):</b> less or equal; <b>Value source:</b> Static; <b>Value:</b> 26. Click <b>Add</b> (28).'
    5:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-13-pe.png
        title: 'Click <b>Save</b> (29).'

high-temperature-alarm-rule-6:
    0:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-14-pe.png
        title: 'Now, add the condition to clear the alarm. Click the <b>Add clear condition</b> (30).'
    1:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-15-pe.png
        title: 'Click <b>Add condition</b> (31).'
    2:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-16-pe.png
        title: 'Click the <b>Add argument filter</b> (32).'
    3:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-17-pe.png
    ...
    4:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-18-pe.png
        title: 'Click <b>Save</b> (37).'

high-temperature-alarm-rule-7:
    0:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-19-pe.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-20-pe.png
        title: 'The "High temperature" alarm rule has been created and is active immediately.'

all-alarms-rules:
    0:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-21-pe.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-22-pe.png
    ...
    2:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-23-pe.png
        title: 'Set the "air-sensor" device profile as the target entity of the alarm rule.<br>Finally, click <b>Add</b> to save the rule.'
    3:
        image: https://img.thingsboard.io/user-guide/advanced-guides-for-working-with-dashboard/lesson-4/high-temperature-alarm-rule-24-pe.png
