...
However, in the age of IoT and IoT platforms, standalone smart meters give way to more advanced and multipurpose smart metering solutions. 
...
You can not only centralize data collection from various smart meters but also create custom visualization dashboards, configure user alerts and notifications, and feed the collected data into other applications or data storage systems.
