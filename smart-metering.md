...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/smart-metering/sm1.png" alt="smart metering 1">
    </div>
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/smart-metering/sm2.png" alt="smart metering 2">
    </div>
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/smart-metering/sm3.png" alt="smart metering 3">
    </div>
    <div>
        <img class="item-image" src="https://img.thingsboard.io/usecases/smart-metering/sm4.png" alt="smart metering 4">
    </div>
</div>
