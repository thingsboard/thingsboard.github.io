...
The simplest way to configure MQTTS is to make your MQTT load balancer (GCP TCP LB) to act as a TLS termination point.
...
where **YOUR_JKS_FILENAME** is the name of your **.jks** file. Then, uncomment all sections in the '{{tbServicesFile}}' file that are marked with "Uncomment the following lines to enable two-way MQTTS".
