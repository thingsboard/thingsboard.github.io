...
``` 
docker volume create tb-http-integration-logs
docker volume create tb-http-integration-logs
```
...
- `-v tb-http-integration-logs:/var/log/tb-http-integration`   - mounts the host's dir `~/.tb-pe-http-integration-logs` to ThingsBoard logs directory;
