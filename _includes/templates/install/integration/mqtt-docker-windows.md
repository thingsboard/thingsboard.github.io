...
``` 
docker volume create tb-mqtt-integration-logs
docker volume create tb-mqtt-integration-logs
```
...
- `-v tb-mqtt-integration-logs:/var/log/tb-mqtt-integration`   - mounts the host's dir `~/.tb-pe-mqtt-integration-logs` to ThingsBoard logs directory;
