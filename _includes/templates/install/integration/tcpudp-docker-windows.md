...
--name my-tb-pe-tcp-udp-integration --restart always thingsboard/tb-pe-tcp-udp-integration:3.0.1PE
```
{: .copy-code}
...
- `thingsboard/tb-pe-tcp-udp-integration:3.0.1PE`          - docker image.
