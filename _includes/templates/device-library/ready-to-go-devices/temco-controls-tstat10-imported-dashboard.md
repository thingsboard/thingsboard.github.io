...
![imagePe](/images/device-library/ready-to-go-devices/temco-tstat10/temco-tstat10-dashboard-ce.png)
{% else %}  
![imageCe](/images/device-library/ready-to-go-devices/temco-tstat10/temco-tstat10-dashboard-ce.png)
{% endif %}
