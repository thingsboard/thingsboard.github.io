...
{% assign deviceNameAndProfileTopicAndConstantJson = '
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/attributes-time-series-json-path-2.png,
        title: In the opened data mapping windows, click on the "**pencil**" icon next to the "**Attributes**" section.
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/attributes-time-series-json-path-3.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/attributes-time-series-json-path-4.png,
        title: Remember to save your changes by clicking the designated button.
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/attributes-time-series-json-path-5.png,
        title: In the opened data mapping windows, click on the "**pencil**" icon next to the "**Time series**" section.
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/attributes-time-series-json-path-6.png,
     ...
     ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/attributes-time-series-json-path-7.png,
        title: Remember to save your changes by clicking the designated button.
'
%}
...
![image](https://img.thingsboard.io/gateway/mqtt-connector/examples/result-device-overview-2.png)
...
![image](https://img.thingsboard.io/gateway/mqtt-connector/examples/result-device-overview-1.png)
