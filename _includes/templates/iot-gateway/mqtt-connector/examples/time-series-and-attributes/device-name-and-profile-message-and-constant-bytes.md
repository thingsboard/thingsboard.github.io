...
{% assign deviceNameAndProfileTopicAndConstantJson = '
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/device-name-and-profile-message-and-constant-bytes-4.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/device-name-and-profile-message-and-constant-bytes-5.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/device-name-and-profile-message-and-constant-bytes-6.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/device-name-and-profile-message-and-constant-bytes-7.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/device-name-and-profile-message-and-constant-bytes-8.png,
...
![image](https://img.thingsboard.io/gateway/mqtt-connector/examples/device-name-and-profile-message-and-constant-bytes-9.png)
