...
{% assign deviceNameAndProfileTopicAndConstantJson = '
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/connect-request-gateway.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/connect-request-1.png,
        title: Select `Connect request` in the **Request type** field then fill the "**Topic filter**" with `sensor/connect`.
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/connect-request-2.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/connect-request-3.png,
        title: Remember to save your changes by clicking the designated button.
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/connect-request-4.png,
        title: Select `Connect request` in the **Request type** field then fill the "**Topic filter**" with `sensor/+/connect`.
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/connect-request-5.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/mqtt-connector/examples/connect-request-6.png,
        title: Remember to save your changes by clicking the designated button.
'
%}
...
![image](https://img.thingsboard.io/gateway/mqtt-connector/examples/result-device-overview-1-connect.png)
...
![image](https://img.thingsboard.io/gateway/mqtt-connector/examples/result-device-overview-connect-2.png)

![image](https://img.thingsboard.io/gateway/mqtt-connector/examples/result-device-overview-connect-3.png)
