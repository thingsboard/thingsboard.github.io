...
{% assign attributesAndTimeSeriesRelativePathIdentifierDeviceNode = '
    ...
    ===
        image: https://img.thingsboard.io/gateway/opc-ua-connector/examples/attributes-time-series-relative-path-device-identifier-1.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/opc-ua-connector/examples/attributes-time-series-relative-path-device-identifier-2.png,
    ...
    ===
        image: https://img.thingsboard.io/gateway/opc-ua-connector/examples/attributes-time-series-relative-path-device-identifier-3.png,
...
![image](https://img.thingsboard.io/gateway/opc-ua-connector/examples/result-device-overview-relative-path-device-identifier.png)
