...
{% assign rollingArgumentType = '
    ===
        image: /images/user-guide/calculated-fields/propagation/propagation-calculation-rolling-argument-1-ce.png
    ...
    ===
        image: /images/user-guide/calculated-fields/propagation/propagation-calculation-rolling-argument-2-ce.png
