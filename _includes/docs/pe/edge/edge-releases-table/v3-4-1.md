...
**Minor** release with everything from [TB CE v3.4.1](/docs/pe/releases/releases-table/v3-4-x/#thingsboard-pe-v341-august-18-2022){: target="_blank"} with the following improvements and bug fixes:
