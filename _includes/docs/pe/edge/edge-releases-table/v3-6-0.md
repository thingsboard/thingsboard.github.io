...
**Major** release with everything from [TB CE v3.6](/docs/pe/releases/releases-table/v3-6-x/#thingsboard-pe-v360-sep-21-2023){: target="_blank"} with the following improvements and bug fixes:
