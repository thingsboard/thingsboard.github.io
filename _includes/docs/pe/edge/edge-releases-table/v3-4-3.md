...
**Minor** release with everything from [TB CE v3.4.3](/docs/pe/releases/releases-table/v3-4-x/#thingsboard-pe-v343-december-21-2022){: target="_blank"} with the following improvements and bug fixes:
