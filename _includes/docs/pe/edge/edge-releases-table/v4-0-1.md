...
**Major** release with everything (except the Calculated Fields feature) from [TB CE v4.0](/docs/pe/releases/releases-table/v4-0-x/#thingsboard-pe-v400-apr-15-2025){: target="_blank"} and [TB CE v4.0.1](/docs/pe/releases/releases-table/v4-0-x/#thingsboard-pe-v401-apr-22-2025){: target="_blank"}:
