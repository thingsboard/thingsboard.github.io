...
**Minor** release with everything from [TB CE v3.6.1](/docs/pe/releases/releases-table/v3-6-x/#thingsboard-pe-v361-nov-13-2023){: target="_blank"} with the following improvements and bug fixes:
