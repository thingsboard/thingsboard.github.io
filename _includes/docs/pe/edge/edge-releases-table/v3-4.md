...
Everything from [TB CE v3.4](/docs/pe/releases/releases-table/v3-4-x/#thingsboard-pe-v34-july-19-2022){: target="_blank"} with the following improvements and bug fixes:
