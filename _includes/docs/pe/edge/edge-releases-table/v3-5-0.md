...
**Major** release with everything from [TB CE v3.5](/docs/pe/releases/releases-table/v3-5-x/#thingsboard-pe-v350-may-9-2023){: target="_blank"} with the following improvements and bug fixes:
