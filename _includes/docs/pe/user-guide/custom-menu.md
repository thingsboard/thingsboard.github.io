...
| tenants                   | This parameter provides the option to hide the "Tenants" item on the left panel  (only at the system administrator level)               |
...
| oauth2                    | This parameter provides the option to hide the "Oauth2" item on the left panel (only at the system administrator level)                 |
| ---                       
