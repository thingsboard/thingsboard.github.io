...
### SigFox Integration Setup
 ...
 - Go to *Integrations* page and click "plus" icon to add a new integration. Name it "*SigFox Integration*", select type *SigFox*;
...
The notification will contain link to the *Sigfox-2216792* device provisioned by the integration (your device name may differ from the one shown in this example). Navigate to this device.
