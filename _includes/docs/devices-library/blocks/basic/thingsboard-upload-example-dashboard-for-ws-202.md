...
{% assign importDashboardCE = '
    ...
    ===
        image: /images/user-guide/dashboards/managing-dashboard/import-dashboard-ws202-2-ce.png,
        title: In the dashboard import window, upload the JSON file and click "**Import**" button.
    ===
        image: /images/user-guide/dashboards/managing-dashboard/import-dashboard-ws202-3-ce.png,
