...
Go to the Payload formatters page and select Custom Javascript formatter for Formatter   
type. Paste the decode function and click Save changes button.  

Download the JSON file with the uplink converter settings by clicking the button below:  

https://github.com/LoRaWAN-Product-Decoder/MOKOSMART-LoRaWAN-Product-Decoder/blob/main/LW001-BG%20PRO%20V2/LW001-BG%20PRO%20V2%20on%20TTN.js
...
Now, navigate to the "Integrations" page under the "Integrations center" section and follow these steps:  
