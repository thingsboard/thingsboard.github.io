...
- **Microsoft Teams**. Notifications will send as a Microsoft Teams message to the list of Users or Channels. To send notifications via Microsoft Teams, a tenant administrator must get **webhook URL** for a needed channel using this [guide](/docs/{{docsPrefix}}user-guide/ui/microsoft-teams-settings/).
...
As a platform user, you may send notifications as a Microsoft Teams message to a list of Users or Channels.
