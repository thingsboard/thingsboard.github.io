...
{% include images-gallery.html imageCollection="export-dashboard" showListImageTitles="true" %}
...
enter edit mode and add new widgets using the corresponding icons in the toolbar.
...
Once you switch to the edit mode, you can add new [widgets](/docs/{{docsPrefix}}user-guide/dashboards/#widgets) and access controls in the dashboard toolbar.
...
Toolbar settings allow display/hide toolbar icons you’re currently using and expand the dashboard to the full screen.

Let's hide "Display dashboards selection", "Display timewindow" and "Display export" icons on the dashboard page.
...
The layouts' settings are identical to the layout settings and the background settings of the dashboard settings.
