...
* Very simple setup, literally: 10 minutes to deploy using [our installation guides](/docs/{{docsPrefix}}installation/).
...
Adding [Premium support](/docs/{{docsPrefix}}services/support/) package results in ~850 USD per month or 0.085 USD per month per device.  
...
Adding [Premium support](/docs/{{docsPrefix}}services/support/) package results in ~1000 USD per month or 0.1 USD per month per device.  
