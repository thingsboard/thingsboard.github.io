...
{% include /docs/device-library/blocks/integrations/converters/basic/add-or-change-converter-block.md integration-type="thethingsindustries" integration-type-correct-name="The Things Industries" %}
