...
{% assign AddDeviceOnChirpstack = '
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/1.png,
        title: Login to ChirpStack server. Go to the **Device profiles** page and click on **Add device profile** button.
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/2.png,
        title: Fill the fields.
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/3.png,
        title: Go to the **Codec** page and paste the script just copied. Click **Submit** button.
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/4.png,
        title: Go to the **Applications** page, and click on "**Add application**".
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/5.png,
        title: Named your application. **Click Submit**.
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/6.png,
        title: Open created application and press **Add device** button.
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/7.png,
    ...
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/8.png,
...
{% assign configureApplicationIntegrationWithThingsBoard = '
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/9.png,
        title: Go to the "**Integrations**" page, find and select the **ThingsBoard**.  
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/10.png,
...
{% assign createDeviceOnThingsBoard = '
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/11.png,
        title: **Log in** to your **ThingsBoard** account. Navigate to the **Devices** page and click the "**+**" button to add a new device.
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/12.png,
        title: Enter the **device name** and click **Next: Credentials**. 
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/13.png,
    ...
    ===
        image: https://img.thingsboard.io/devices-library/ready-to-go-devices/lw001-bg-pro/14.png,
