...
![one-way-rpc-widget](/images/device-library/basic/single-board-computers/one-way-rpc-widget.png)
...
![timeseries-rpc-widget](/images/device-library/basic/single-board-computers/timeseries-rpc-widget.png)
