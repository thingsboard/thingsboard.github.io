...
![Check telemetry on device](/images/device-library/ready-to-go-devices/ws101-smart-button/check-telemetry-on-device.png)
...
![Dashboard](/images/device-library/ready-to-go-devices/ws101-smart-button/example-of-the-dashboard-pe.png)