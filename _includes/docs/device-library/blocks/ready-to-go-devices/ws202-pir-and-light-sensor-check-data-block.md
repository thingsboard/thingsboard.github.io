...
![Check telemetry on device](/images/device-library/ready-to-go-devices/ws202-pir-and-light-sensor/check-telemetry-on-device.png)
...
![Dashboard](/images/device-library/ready-to-go-devices/ws202-pir-and-light-sensor/example-of-the-dashboard-pe.png)