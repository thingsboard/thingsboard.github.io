...
![wiring1](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/wiring1.png)
![wiring2](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/wiring2.png)
...
![thingsboard_login](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/thingsboard_login.png)
...
![add_new_device](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/add_new_device.png)

<br>**3.** Enter a device name (e.g., **Elastel_EG500**) and click "**Add**".

![add_device_name](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/add_device_name.png)

<br>**4. Copy and save the Access token**

It will be needed in further device configuration for connecting to ThingsBoard cloud.

![access token](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/access_token.png)
...
![enable data collect](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/basic_setting.png)
...
![rs485 interface setting](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/rs485_interface.png)
...
![Modbus rule settings](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/modbus_rule_settings.png)
...
![IO settings](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/io_settings.png)

## Connect device to ThingsBoard

Go to the **Data Collect** -> **North Apps** -> **Reporting Center** to configure the connection to ThingsBoard platform via MQTT.

![Connect mqtt to ThingsBoard](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/mqtt_thingsboard_connect.png)
...
![check data on thingsboard](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/data_on_thingsboard.png)

<br>You can also view the data on EG500&#39;s local dashboard.

![data on device local](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/data_on_devicelocal.png)
...
![add dashboard](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/add_dashboard.png)
...
![add widget](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/add_widget.png)
...
![add temperature widget](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/add_temp_widget.png)
...
![temperature widget](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/temperature_widget.png)
...
![add other widget](/images/device-library/basic/single-board-computers/raspberry-pi-cm4/other_widget.png)
