...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-1.png)
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-2.png)

- Click the integrations tab and start to add an integration by selecting an integration type.

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-3.png)

- Here we are selecting the HTTP for our RN172 device.

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-4.png)

- Then add a name for the integration.

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-5.png)
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-6.png)

- Then completed the integration setup.

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-7.png)

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-8.png)
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-9.png)

- In the network setup we can add the Wi-Fi SSID and Password.

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-10.png))
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-11.png)

- From the **Integration** tab of ThingsBoard, copy **HTTP endpoint URL** to set in the Radionode terminal program.

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-12.png)

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-13.png)
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-14.png)
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-15.png)

- **Enter a name** for the Dashboard and then click the **Add** button.

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-16.png)

After creation, the dashboard will open automatically, and you can start adding widgets right away. Click **Add widget**.

![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-17.png)
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-18.png)
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-19.png)
...
![image](/images/device-library/ready-to-go-devices/rn172wcd/rn172wcd-20.png)
