...
![Enterprise IIoT Gateway Lite](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/3-ncd-to-thingsboard-IIoT-Gateway-Lite.png){: style="float: left; max-width: 200px; max-height: 200px; margin: 0px 10px 0px 0px"}
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/4-ncd-to-thingsboard-overview.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/5-ncd-to-thingsboard-nodered.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/6-ncd-to-thingsboard-vibration-sensor-inside.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/7-ncd-to-thingsboard-debug-window.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/8-ncd-to-thingsboard-debug-run-message.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/28-ncd-to-thingsboard-node-red-import.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/29-ncd-to-thingsboard-node-red-import.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/30-ncd-to-thingsboard-node-red-importing.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/31-ncd-to-thingsboard-node-red-connect.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/32-ncd-to-thingsboard-node-red-info.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/33-ncd-to-thingsboard-node-red-filter.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/34-ncd-to-thingsboard-node-red-run-mode.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/35-ncd-to-thingsboard-node-red-set-device.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/36-ncd-to-thingsboard-node-red-topic-connect.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/37-ncd-to-thingsboard-node-red-filter-by-type.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/38-ncd-to-thingsboard-node-red-topic-atributes.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/39-ncd-to-thingsboard-node-red-battery.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/40-ncd-to-thingsboard-node-red-topic-telemetry.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/41-ncd-to-thingsboard-node-red-mqtt-node.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/42-ncd-to-thingsboard-node-red-add-new-mqtt.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/43-ncd-to-thingsboard-node-red-client-id.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/44-ncd-to-thingsboard-node-red-security.png)

<br>
Finally, to save the configurations made within the node, click the "**Update**" button.

![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/45-ncd-to-thingsboard-node-red-update.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/46-ncd-to-thingsboard-node-red-mqtt-server.png)

<br>
To save the changes made within the MQTT out node, click on the "**Done**" icon.

![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/47-ncd-to-thingsboard-node-red-done.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/48-ncd-to-thingsboard-node-red-deploy.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/48-ncd-to-thingsboard-node-red-mqtt-node.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/49-ncd-to-thingsboard-node-red-mqtt-node-connected.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/50-ncd-to-thingsboard-vibration-reset-button.jpg)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/51-ncd-to-thingsboard-node-red-mqtt-messages.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/52-ncd-to-thingsboard-node-red-mqtt-connect.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/53-ncd-to-thingsboard-node-red-mqtt-attributes.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/54-ncd-to-thingsboard-debug-sensor-data.png)
...
![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/adding-new-dashboard-17-pe.png)

Finally, our dashboard is displayed as follows:

![image](/images/device-library/ready-to-go-devices/ncd-vibration-temperature-sensor/adding-new-dashboard-18-pe.png)
